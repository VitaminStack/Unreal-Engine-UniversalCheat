...
#include "BP_HangarDoor_classes.hpp"
#include "BP_HangarDoor_parameters.hpp"
...
void ABP_HangarDoor_C::GetItemInfo(class UJigsawItem_DataAsset_C** Info, int32* Count, struct FS_RandomStatsConfig* RandomStatsConfig, TMap<class FString, class FString>* CustomData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_HangarDoor_C", "GetItemInfo");

	Params::BP_HangarDoor_C_GetItemInfo Parms{};
