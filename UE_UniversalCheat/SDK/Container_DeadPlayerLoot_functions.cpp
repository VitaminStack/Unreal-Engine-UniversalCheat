...
#include "Container_DeadPlayerLoot_classes.hpp"
#include "Container_DeadPlayerLoot_parameters.hpp"
...
void AContainer_DeadPlayerLoot_C::BndEvt__BP_MPLootContainer_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature(bool bIsBeyondLastLayer, int32 LayerIndex, bool bIsSeen)
{
	...
	Params::Container_DeadPlayerLoot_C_BndEvt__BP_MPLootContainer_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature Parms{};
...
void AContainer_DeadPlayerLoot_C::CheckDistanceFromActor()
{
	static class UFunction* Func = nullptr;
...
void AContainer_DeadPlayerLoot_C::ExecuteUbergraph_Container_DeadPlayerLoot(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_ExecuteUbergraph_Container_DeadPlayerLoot Parms{};
...
void AContainer_DeadPlayerLoot_C::GetInteractOptions(TMap<struct FGameplayTag, class FText>* Options)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_GetInteractOptions Parms{};
...
void AContainer_DeadPlayerLoot_C::GetItemInfo(class UJigsawItem_DataAsset_C** Info, int32* Count, struct FS_RandomStatsConfig* RandomStatsConfig, TMap<class FString, class FString>* CustomData)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_GetItemInfo Parms{};
...
void AContainer_DeadPlayerLoot_C::GetJigMultiplayerComponent(class UActorComponent** JigComp)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_GetJigMultiplayerComponent Parms{};
...
void AContainer_DeadPlayerLoot_C::GetMainSceneComp(class USceneComponent** Comp)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Container_DeadPlayerLoot_C", "GetMainSceneComp");

	Params::Container_DeadPlayerLoot_C_GetMainSceneComp Parms{};
...
void AContainer_DeadPlayerLoot_C::JigCanInteract(bool* Result)
{
	...
	Params::Container_DeadPlayerLoot_C_JigCanInteract Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_GetLootWidget(class UWidget** Result, bool* Valid_)
{
	...
	Params::Container_DeadPlayerLoot_C_JigMP_GetLootWidget Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnContainersSwap(class UJSIContainer_C* Container1, class UJSIContainer_C* Container2, bool* Result)
{
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnContainersSwap Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnItemAdded(const struct FGuid& ItemUID, const struct FGuid& FromContainerUID, const struct FGuid& ToContainerUID, class UActorComponent* FromComponent, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnItemAdded Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnItemConsumed(const struct FRepItemInfo& ConsumedItem, int32 Amount, int32 Remaining, const struct FRepItemInfo& InsideOf, class FName FromContainer, const class FString& CustomData, bool CallbackToPlayer_, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnItemConsumed Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnItemDropped(const struct FGuid& ItemUID, const struct FGuid& FromContainerUID, class AActor* ActorRef, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnItemDropped Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnItemMoved(const struct FGuid& ItemUID, const struct FGuid& FromContainerUID, const struct FGuid& ToContainerUID, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnItemMoved Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnItemRemoved(const struct FGuid& ItemUID, const struct FGuid& FromContainerUID, const struct FGuid& ToContainerUID, class UActorComponent* ToComponent, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnItemRemoved Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnMainContainerItemAdded(const struct FGuid& ToContainerUID, const struct FGuid& ItemUID, class FName ToContainerName, const struct FRepItemInfo& ItemInfo, class FName FromMain, bool* Result, class AActor** ActorRef)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnMainContainerItemAdded Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnMainContainerItemRemoved(const struct FGuid& FromContainerUID, const struct FGuid& ItemUID, class FName ContainerName_0, const struct FRepItemInfo& ItemRemovedInfo, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnMainContainerItemRemoved Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnPickupAdded(const struct FRepItemInfo& Info, const struct FGuid& ItemUID, const struct FGuid& ToContainerUID, class FName ToContainer, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnPickupAdded Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnPickupEquipped(class AActor* ActorRef, class FName ToContainerName, const struct FGuid& UID, const struct FGuid& ToContainerUID, const struct FRepItemInfo& Info, bool* Result, class AActor** OverrideActor)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnPickupEquipped Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnRequestDropItem(const struct FRepItemInfo& ItemInfo, class FName ContainerName_0, class AActor** ActorRef)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnRequestDropItem Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnTwoContainersSwap(class FName FromContainer, class FName ToContainer, bool* Result)
{
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnTwoContainersSwap Parms{};
...
void AContainer_DeadPlayerLoot_C::JigMP_OnUpdateChamberUID(const struct FGuid& NewUID, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_JigMP_OnUpdateChamberUID Parms{};
...
void AContainer_DeadPlayerLoot_C::JigSetCanInteract(bool CanInteract, bool EnablePhysics, bool* Result)
{
	...
	Params::Container_DeadPlayerLoot_C_JigSetCanInteract Parms{};
...
void AContainer_DeadPlayerLoot_C::OnBeginInteract(class AActor* InteractingActor, const TMap<struct FGameplayTag, class FText>& Options)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_OnBeginInteract Parms{};
...
void AContainer_DeadPlayerLoot_C::OnExecuteInteract(class AActor* InteractingActor, const struct FGameplayTag& Option)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_OnExecuteInteract Parms{};
...
void AContainer_DeadPlayerLoot_C::OnExecuteInteractDialogue(class AActor* InteractingActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Container_DeadPlayerLoot_C", "OnExecuteInteractDialogue");

	Params::Container_DeadPlayerLoot_C_OnExecuteInteractDialogue Parms{};
...
void AContainer_DeadPlayerLoot_C::OnRequestServerInteract(class AActor* Actor, const struct FGameplayTag& Option, const struct FS_JigPayload& Payload, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_OnRequestServerInteract Parms{};
...
void AContainer_DeadPlayerLoot_C::OnServerExecuteInteract(const struct FGameplayTag& Option, class AActor* ByActor, const struct FS_JigPayload& Payload)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_OnServerExecuteInteract Parms{};
...
void AContainer_DeadPlayerLoot_C::OnStopExecuteInteract(class AActor* InteractingActor)
{
	...
	Params::Container_DeadPlayerLoot_C_OnStopExecuteInteract Parms{};
...
// Function Container_DeadPlayerLoot.Container_DeadPlayerLoot_C.PickupBuildFromGround
// (Public, BlueprintCallable, BlueprintEvent)

void AContainer_DeadPlayerLoot_C::PickupBuildFromGround()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Container_DeadPlayerLoot_C", "PickupBuildFromGround");
...
void AContainer_DeadPlayerLoot_C::SetInspected(const class FText& InText)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_SetInspected Parms{};
...
void AContainer_DeadPlayerLoot_C::SetInteractDistance(class AActor* Target)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_SetInteractDistance Parms{};
...
void AContainer_DeadPlayerLoot_C::SetInteractOption(const struct FGameplayTag& Option)
{
	static class UFunction* Func = nullptr;
	...
	Params::Container_DeadPlayerLoot_C_SetInteractOption Parms{};
...
void AContainer_DeadPlayerLoot_C::SetPickupCount(int32 NewCount, bool* Result)
{
	...
	Params::Container_DeadPlayerLoot_C_SetPickupCount Parms{};
...
void AContainer_DeadPlayerLoot_C::TraceForFloor()
{
	static class UFunction* Func = nullptr;
