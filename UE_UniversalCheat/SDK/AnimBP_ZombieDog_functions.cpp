...
#include "AnimBP_ZombieDog_classes.hpp"
#include "AnimBP_ZombieDog_parameters.hpp"
...
void UAnimBP_ZombieDog_C::AnimGraph(struct FPoseLink* AnimGraph_0)
{
	...
	Params::AnimBP_ZombieDog_C_AnimGraph Parms{};
...
void UAnimBP_ZombieDog_C::BlueprintThreadSafeUpdateAnimation(float DeltaTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AnimBP_ZombieDog_C", "BlueprintThreadSafeUpdateAnimation");

	Params::AnimBP_ZombieDog_C_BlueprintThreadSafeUpdateAnimation Parms{};
...
void UAnimBP_ZombieDog_C::CombatState(int32 BlendSpace)
{
	...
	Params::AnimBP_ZombieDog_C_CombatState Parms{};
...
void UAnimBP_ZombieDog_C::DeathState(bool Dead_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::AnimBP_ZombieDog_C_DeathState Parms{};
...
void UAnimBP_ZombieDog_C::ExecuteUbergraph_AnimBP_ZombieDog(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::AnimBP_ZombieDog_C_ExecuteUbergraph_AnimBP_ZombieDog Parms{};
...
void UAnimBP_ZombieDog_C::GetSpeed()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AnimBP_ZombieDog_C", "GetSpeed");
