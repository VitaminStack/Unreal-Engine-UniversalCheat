...
#include "TentContainer1_Widget_classes.hpp"
#include "TentContainer1_Widget_parameters.hpp"
...
void UTentContainer1_Widget_C::GetJSIContainerByPlayerSlots(const struct FGameplayTag& Slot_0, class UJSIContainer_C** Container, class UJSI_Slot_C** EquippedItem, bool* IsPending_)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TentContainer1_Widget_C", "GetJSIContainerByPlayerSlots");

	Params::TentContainer1_Widget_C_GetJSIContainerByPlayerSlots Parms{};
...
void UTentContainer1_Widget_C::GetListOfContainers(TArray<class UJSIContainer_C*>* Containers) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TentContainer1_Widget_C", "GetListOfContainers");

	Params::TentContainer1_Widget_C_GetListOfContainers Parms{};
