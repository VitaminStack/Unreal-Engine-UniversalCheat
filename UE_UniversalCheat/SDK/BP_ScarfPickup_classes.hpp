...
// BlueprintGeneratedClass BP_ScarfPickup.BP_ScarfPickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_ScarfPickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_ScarfPickup_C;                   // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_ScarfPickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_ScarfPickup_C">();
	}
	static class ABP_ScarfPickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_ScarfPickup_C>();
	}
};
static_assert(alignof(ABP_ScarfPickup_C) == 0x000008, "Wrong alignment on ABP_ScarfPickup_C");
static_assert(sizeof(ABP_ScarfPickup_C) == 0x000318, "Wrong size on ABP_ScarfPickup_C");
static_assert(offsetof(ABP_ScarfPickup_C, UberGraphFrame_BP_ScarfPickup_C) == 0x000310, "Member 'ABP_ScarfPickup_C::UberGraphFrame_BP_ScarfPickup_C' has a wrong offset!");
