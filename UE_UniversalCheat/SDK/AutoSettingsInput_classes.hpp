...
{
public:
	int32                                         MappingGroup;                                      // 0x02C0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           KeyGroup;                                          // 0x02C4(0x0008)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUsePlayerKeyGroup;                                // 0x02CC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2CD[0x3];                                      // 0x02CD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  IconTags;                                          // 0x02D0(0x0020)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInputLabel) == 0x0002F0, "Wrong size on UInputLabel");
static_assert(offsetof(UInputLabel, MappingGroup) == 0x0002C0, "Member 'UInputLabel::MappingGroup' has a wrong offset!");
static_assert(offsetof(UInputLabel, KeyGroup) == 0x0002C4, "Member 'UInputLabel::KeyGroup' has a wrong offset!");
static_assert(offsetof(UInputLabel, bUsePlayerKeyGroup) == 0x0002CC, "Member 'UInputLabel::bUsePlayerKeyGroup' has a wrong offset!");
static_assert(offsetof(UInputLabel, IconTags) == 0x0002D0, "Member 'UInputLabel::IconTags' has a wrong offset!");

// Class AutoSettingsInput.ActionLabel
// 0x0068 (0x0358 - 0x02F0)
class UActionLabel final : public UInputLabel
{
public:
	class FName                                   ActionName;                                        // 0x02F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UKeyLabel>                  KeyLabelWidgetClass;                               // 0x02F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoClear, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UWidget>                    KeySeparatorWidgetClass;                           // 0x0300(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPanelWidget*                           KeyContainer;                                      // 0x0308(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UKeyLabel*                              PrimaryKeyLabel;                                   // 0x0310(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UKeyLabel*                              ShiftLabel;                                        // 0x0318(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UKeyLabel*                              CtrlLabel;                                         // 0x0320(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UKeyLabel*                              AltLabel;                                          // 0x0328(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UKeyLabel*                              CmdLabel;                                          // 0x0330(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWidget*                                ShiftSeparator;                                    // 0x0338(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWidget*                                CtrlSeparator;                                     // 0x0340(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWidget*                                AltSeparator;                                      // 0x0348(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWidget*                                CmdSeparator;                                      // 0x0350(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UActionLabel) == 0x000358, "Wrong size on UActionLabel");
static_assert(offsetof(UActionLabel, ActionName) == 0x0002F0, "Member 'UActionLabel::ActionName' has a wrong offset!");
static_assert(offsetof(UActionLabel, KeyLabelWidgetClass) == 0x0002F8, "Member 'UActionLabel::KeyLabelWidgetClass' has a wrong offset!");
static_assert(offsetof(UActionLabel, KeySeparatorWidgetClass) == 0x000300, "Member 'UActionLabel::KeySeparatorWidgetClass' has a wrong offset!");
static_assert(offsetof(UActionLabel, KeyContainer) == 0x000308, "Member 'UActionLabel::KeyContainer' has a wrong offset!");
static_assert(offsetof(UActionLabel, PrimaryKeyLabel) == 0x000310, "Member 'UActionLabel::PrimaryKeyLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, ShiftLabel) == 0x000318, "Member 'UActionLabel::ShiftLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, CtrlLabel) == 0x000320, "Member 'UActionLabel::CtrlLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, AltLabel) == 0x000328, "Member 'UActionLabel::AltLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, CmdLabel) == 0x000330, "Member 'UActionLabel::CmdLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, ShiftSeparator) == 0x000338, "Member 'UActionLabel::ShiftSeparator' has a wrong offset!");
static_assert(offsetof(UActionLabel, CtrlSeparator) == 0x000340, "Member 'UActionLabel::CtrlSeparator' has a wrong offset!");
static_assert(offsetof(UActionLabel, AltSeparator) == 0x000348, "Member 'UActionLabel::AltSeparator' has a wrong offset!");
static_assert(offsetof(UActionLabel, CmdSeparator) == 0x000350, "Member 'UActionLabel::CmdSeparator' has a wrong offset!");
...
{
public:
	int32                                         MappingGroup;                                      // 0x02C0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTag                           KeyGroup;                                          // 0x02C4(0x0008)(Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2CC[0x4];                                      // 0x02CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  IconTags;                                          // 0x02D0(0x0020)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	class UBindCaptureButton*                     BindCaptureButton;                                 // 0x02F0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UInputMapping) == 0x0002F8, "Wrong size on UInputMapping");
static_assert(offsetof(UInputMapping, MappingGroup) == 0x0002C0, "Member 'UInputMapping::MappingGroup' has a wrong offset!");
static_assert(offsetof(UInputMapping, KeyGroup) == 0x0002C4, "Member 'UInputMapping::KeyGroup' has a wrong offset!");
static_assert(offsetof(UInputMapping, IconTags) == 0x0002D0, "Member 'UInputMapping::IconTags' has a wrong offset!");
static_assert(offsetof(UInputMapping, BindCaptureButton) == 0x0002F0, "Member 'UInputMapping::BindCaptureButton' has a wrong offset!");

// Class AutoSettingsInput.ActionMapping
// 0x0010 (0x0308 - 0x02F8)
class UActionMapping final : public UInputMapping
{
public:
	class FName                                   ActionName;                                        // 0x02F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UActionLabel*                           ActionLabel;                                       // 0x0300(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UActionMapping) == 0x000308, "Wrong size on UActionMapping");
static_assert(offsetof(UActionMapping, ActionName) == 0x0002F8, "Member 'UActionMapping::ActionName' has a wrong offset!");
static_assert(offsetof(UActionMapping, ActionLabel) == 0x000300, "Member 'UActionMapping::ActionLabel' has a wrong offset!");
...
class UAxisLabel final : public UInputLabel
{
public:
	class FName                                   AxisName;                                          // 0x02F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Scale;                                             // 0x02F8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2FC[0x4];                                      // 0x02FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UKeyLabel*                              KeyLabel;                                          // 0x0300(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAxisLabel) == 0x000308, "Wrong size on UAxisLabel");
static_assert(offsetof(UAxisLabel, AxisName) == 0x0002F0, "Member 'UAxisLabel::AxisName' has a wrong offset!");
static_assert(offsetof(UAxisLabel, Scale) == 0x0002F8, "Member 'UAxisLabel::Scale' has a wrong offset!");
static_assert(offsetof(UAxisLabel, KeyLabel) == 0x000300, "Member 'UAxisLabel::KeyLabel' has a wrong offset!");

// Class AutoSettingsInput.AxisMapping
// 0x0018 (0x0310 - 0x02F8)
class UAxisMapping final : public UInputMapping
{
public:
	class FName                                   AxisName;                                          // 0x02F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Scale;                                             // 0x0300(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_304[0x4];                                      // 0x0304(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UAxisLabel*                             AxisLabel;                                         // 0x0308(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAxisMapping) == 0x000310, "Wrong size on UAxisMapping");
static_assert(offsetof(UAxisMapping, AxisName) == 0x0002F8, "Member 'UAxisMapping::AxisName' has a wrong offset!");
static_assert(offsetof(UAxisMapping, Scale) == 0x000300, "Member 'UAxisMapping::Scale' has a wrong offset!");
static_assert(offsetof(UAxisMapping, AxisLabel) == 0x000308, "Member 'UAxisMapping::AxisLabel' has a wrong offset!");

// Class AutoSettingsInput.BindCaptureButton
// 0x0030 (0x02F0 - 0x02C0)
class UBindCaptureButton final : public UUserWidget
{
public:
	struct FGameplayTag                           KeyGroup;                                          // 0x02C0(0x0008)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UBindCapturePrompt>         BindCapturePromptClass;                            // 0x02C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoClear, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CapturePromptZOrder;                               // 0x02D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D4[0x14];                                     // 0x02D4(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	class UBindCapturePrompt*                     Prompt;                                            // 0x02E8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UBindCaptureButton) == 0x0002F0, "Wrong size on UBindCaptureButton");
static_assert(offsetof(UBindCaptureButton, KeyGroup) == 0x0002C0, "Member 'UBindCaptureButton::KeyGroup' has a wrong offset!");
static_assert(offsetof(UBindCaptureButton, BindCapturePromptClass) == 0x0002C8, "Member 'UBindCaptureButton::BindCapturePromptClass' has a wrong offset!");
static_assert(offsetof(UBindCaptureButton, CapturePromptZOrder) == 0x0002D0, "Member 'UBindCaptureButton::CapturePromptZOrder' has a wrong offset!");
static_assert(offsetof(UBindCaptureButton, Prompt) == 0x0002E8, "Member 'UBindCaptureButton::Prompt' has a wrong offset!");

// Class AutoSettingsInput.BindCapturePrompt
// 0x0068 (0x0328 - 0x02C0)
class UBindCapturePrompt final : public UUserWidget
{
public:
	bool                                          bIgnoreGameViewportInputWhileCapturing;            // 0x02C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRestrictKeyGroup;                                 // 0x02C1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EBindingCaptureMode                           CaptureMode;                                       // 0x02C2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C3[0x1];                                      // 0x02C3(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           KeyGroup;                                          // 0x02C4(0x0008)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2CC[0x4];                                      // 0x02CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(const struct FCapturedInput& CapturedInput)> OnChordCaptured;                                   // 0x02D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FCapturedInput& CapturedInput)> OnChordRejected;                                   // 0x02E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(bool bWasCancelled)> OnCapturePromptClosed;                             // 0x02F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TArray<struct FKey>                           KeysDown;                                          // 0x0300(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	bool                                          PreviousIgnoreInput;                               // 0x0310(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_311[0x7];                                      // 0x0311(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              AccumulatedMouseDelta;                             // 0x0318(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UBindCapturePrompt) == 0x000328, "Wrong size on UBindCapturePrompt");
static_assert(offsetof(UBindCapturePrompt, bIgnoreGameViewportInputWhileCapturing) == 0x0002C0, "Member 'UBindCapturePrompt::bIgnoreGameViewportInputWhileCapturing' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, bRestrictKeyGroup) == 0x0002C1, "Member 'UBindCapturePrompt::bRestrictKeyGroup' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, CaptureMode) == 0x0002C2, "Member 'UBindCapturePrompt::CaptureMode' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, KeyGroup) == 0x0002C4, "Member 'UBindCapturePrompt::KeyGroup' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, OnChordCaptured) == 0x0002D0, "Member 'UBindCapturePrompt::OnChordCaptured' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, OnChordRejected) == 0x0002E0, "Member 'UBindCapturePrompt::OnChordRejected' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, OnCapturePromptClosed) == 0x0002F0, "Member 'UBindCapturePrompt::OnCapturePromptClosed' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, KeysDown) == 0x000300, "Member 'UBindCapturePrompt::KeysDown' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, PreviousIgnoreInput) == 0x000310, "Member 'UBindCapturePrompt::PreviousIgnoreInput' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, AccumulatedMouseDelta) == 0x000318, "Member 'UBindCapturePrompt::AccumulatedMouseDelta' has a wrong offset!");
...
class UKeyLabel final : public UUserWidget
{
public:
	class FText                                   KeyInvalidText;                                    // 0x02C0(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   LabelOverride;                                     // 0x02D8(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FKey                                   Key;                                               // 0x02F0(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AxisScale;                                         // 0x0308(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_30C[0x4];                                      // 0x030C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  IconTags;                                          // 0x0310(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UKeyLabel) == 0x000330, "Wrong size on UKeyLabel");
static_assert(offsetof(UKeyLabel, KeyInvalidText) == 0x0002C0, "Member 'UKeyLabel::KeyInvalidText' has a wrong offset!");
static_assert(offsetof(UKeyLabel, LabelOverride) == 0x0002D8, "Member 'UKeyLabel::LabelOverride' has a wrong offset!");
static_assert(offsetof(UKeyLabel, Key) == 0x0002F0, "Member 'UKeyLabel::Key' has a wrong offset!");
static_assert(offsetof(UKeyLabel, AxisScale) == 0x000308, "Member 'UKeyLabel::AxisScale' has a wrong offset!");
static_assert(offsetof(UKeyLabel, IconTags) == 0x000310, "Member 'UKeyLabel::IconTags' has a wrong offset!");
