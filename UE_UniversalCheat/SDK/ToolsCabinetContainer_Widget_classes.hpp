...
class UToolsCabinetContainer_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_ToolsCabinetContainer_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"ToolsCabinetContainer_Widget_C">();
	}
	static class UToolsCabinetContainer_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UToolsCabinetContainer_Widget_C>();
	}
};
static_assert(alignof(UToolsCabinetContainer_Widget_C) == 0x000008, "Wrong alignment on UToolsCabinetContainer_Widget_C");
static_assert(sizeof(UToolsCabinetContainer_Widget_C) == 0x0002D0, "Wrong size on UToolsCabinetContainer_Widget_C");
static_assert(offsetof(UToolsCabinetContainer_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UToolsCabinetContainer_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UToolsCabinetContainer_Widget_C, MainContainer) == 0x0002C8, "Member 'UToolsCabinetContainer_Widget_C::MainContainer' has a wrong offset!");
