...
// WidgetBlueprintGeneratedClass ShippingContainer_Widget.ShippingContainer_Widget_C
// 0x0010 (0x02D0 - 0x02C0)
class UShippingContainer_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_ShippingContainer_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"ShippingContainer_Widget_C">();
	}
	static class UShippingContainer_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UShippingContainer_Widget_C>();
	}
};
static_assert(alignof(UShippingContainer_Widget_C) == 0x000008, "Wrong alignment on UShippingContainer_Widget_C");
static_assert(sizeof(UShippingContainer_Widget_C) == 0x0002D0, "Wrong size on UShippingContainer_Widget_C");
static_assert(offsetof(UShippingContainer_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UShippingContainer_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UShippingContainer_Widget_C, MainContainer) == 0x0002C8, "Member 'UShippingContainer_Widget_C::MainContainer' has a wrong offset!");
