...
// WidgetBlueprintGeneratedClass AmmoStorageContainer_Widget.AmmoStorageContainer_Widget_C
// 0x0010 (0x02D0 - 0x02C0)
class UAmmoStorageContainer_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_AmmoStorageContainer_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AmmoStorageContainer_Widget_C">();
	}
	static class UAmmoStorageContainer_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAmmoStorageContainer_Widget_C>();
	}
};
static_assert(alignof(UAmmoStorageContainer_Widget_C) == 0x000008, "Wrong alignment on UAmmoStorageContainer_Widget_C");
static_assert(sizeof(UAmmoStorageContainer_Widget_C) == 0x0002D0, "Wrong size on UAmmoStorageContainer_Widget_C");
static_assert(offsetof(UAmmoStorageContainer_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UAmmoStorageContainer_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAmmoStorageContainer_Widget_C, MainContainer) == 0x0002C8, "Member 'UAmmoStorageContainer_Widget_C::MainContainer' has a wrong offset!");
