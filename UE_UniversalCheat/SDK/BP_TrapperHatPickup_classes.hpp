...
// BlueprintGeneratedClass BP_TrapperHatPickup.BP_TrapperHatPickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_TrapperHatPickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_TrapperHatPickup_C;              // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_TrapperHatPickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_TrapperHatPickup_C">();
	}
	static class ABP_TrapperHatPickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_TrapperHatPickup_C>();
	}
};
static_assert(alignof(ABP_TrapperHatPickup_C) == 0x000008, "Wrong alignment on ABP_TrapperHatPickup_C");
static_assert(sizeof(ABP_TrapperHatPickup_C) == 0x000318, "Wrong size on ABP_TrapperHatPickup_C");
static_assert(offsetof(ABP_TrapperHatPickup_C, UberGraphFrame_BP_TrapperHatPickup_C) == 0x000310, "Member 'ABP_TrapperHatPickup_C::UberGraphFrame_BP_TrapperHatPickup_C' has a wrong offset!");
