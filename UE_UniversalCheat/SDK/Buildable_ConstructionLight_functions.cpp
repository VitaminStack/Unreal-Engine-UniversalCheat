...
#include "Buildable_ConstructionLight_classes.hpp"
#include "Buildable_ConstructionLight_parameters.hpp"
...
void ABuildable_ConstructionLight_C::OnServerExecuteInteract(const struct FGameplayTag& Option, class AActor* ByActor, const struct FS_JigPayload& Payload)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Buildable_ConstructionLight_C", "OnServerExecuteInteract");

	Params::Buildable_ConstructionLight_C_OnServerExecuteInteract Parms{};
