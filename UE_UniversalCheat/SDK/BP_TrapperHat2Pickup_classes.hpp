...
// BlueprintGeneratedClass BP_TrapperHat2Pickup.BP_TrapperHat2Pickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_TrapperHat2Pickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_TrapperHat2Pickup_C;             // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_TrapperHat2Pickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_TrapperHat2Pickup_C">();
	}
	static class ABP_TrapperHat2Pickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_TrapperHat2Pickup_C>();
	}
};
static_assert(alignof(ABP_TrapperHat2Pickup_C) == 0x000008, "Wrong alignment on ABP_TrapperHat2Pickup_C");
static_assert(sizeof(ABP_TrapperHat2Pickup_C) == 0x000318, "Wrong size on ABP_TrapperHat2Pickup_C");
static_assert(offsetof(ABP_TrapperHat2Pickup_C, UberGraphFrame_BP_TrapperHat2Pickup_C) == 0x000310, "Member 'ABP_TrapperHat2Pickup_C::UberGraphFrame_BP_TrapperHat2Pickup_C' has a wrong offset!");
