...
struct Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin final
{
public:
	...
	bool                                          CallFunc_AddJigWidgetToContent_Result;             // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin) == 0x000008, "Wrong alignment on Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin");
static_assert(sizeof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin) == 0x0000C0, "Wrong size on Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, EntryPoint) == 0x000000, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::EntryPoint' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_ComponentBoundEvent_bIsBeyondLastLayer) == 0x000004, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_ComponentBoundEvent_bIsBeyondLastLayer' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_ComponentBoundEvent_LayerIndex) == 0x000008, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_ComponentBoundEvent_LayerIndex' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_ComponentBoundEvent_bIsSeen) == 0x00000C, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_ComponentBoundEvent_bIsSeen' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, CallFunc_K2_SetTimer_ReturnValue) == 0x000010, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::CallFunc_K2_SetTimer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_Event_Actor) == 0x000018, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_Event_Actor' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, CallFunc_IsInventoryVisible__Result) == 0x000020, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::CallFunc_IsInventoryVisible__Result' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_DynamicCast_AsBP_Jig_Character_Interface) == 0x000028, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_DynamicCast_AsBP_Jig_Character_Interface' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_DynamicCast_bSuccess) == 0x000038, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, CallFunc_Not_PreBool_ReturnValue) == 0x000039, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_DynamicCast_AsBP_Jig_Character_Interface_1) == 0x000040, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_DynamicCast_AsBP_Jig_Character_Interface_1' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_DynamicCast_bSuccess_1) == 0x000050, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, CallFunc_RequestServerData_Result) == 0x000051, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::CallFunc_RequestServerData_Result' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_DynamicCast_AsBPI_Player) == 0x000058, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_DynamicCast_AsBPI_Player' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_DynamicCast_bSuccess_2) == 0x000068, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, CallFunc_SetupInventoryWidget_InventoryWidgetRef) == 0x000070, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::CallFunc_SetupInventoryWidget_InventoryWidgetRef' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_Event_Option) == 0x000078, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_Event_Option' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_Event_ByActor) == 0x000080, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_Event_ByActor' has a wrong offset!");
static_assert(offsetof(Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin, K2Node_Event_Payload) == 0x000088, "Member 'Buildable_TrashBin_C_ExecuteUbergraph_Buildable_TrashBin::K2Node_Event_Payload' has a wrong offset!");
