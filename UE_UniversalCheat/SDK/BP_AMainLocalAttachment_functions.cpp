...
#include "BP_AMainLocalAttachment_parameters.hpp"
...
void ABP_AMainLocalAttachment_C::ExecuteUbergraph_BP_AMainLocalAttachment(int32 EntryPoint)
{
	...
	Params::BP_AMainLocalAttachment_C_ExecuteUbergraph_BP_AMainLocalAttachment Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_AttachmentInstalled(const struct FGuid& MainUID, TArray<struct FS_RepAttachmentInfo>& Attachments, bool* Result, struct FGameplayTag* AttachmentType)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_AMainLocalAttachment_C_Jig_AttachmentInstalled Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_AttachmentRemoved(TArray<struct FS_RepAttachmentInfo>& Attachments, bool* Result, struct FGameplayTag* AttachmentType)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_AMainLocalAttachment_C_Jig_AttachmentRemoved Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_CanChamberWeapon(class UActorComponent* MPComp, const struct FGameplayTag& PlayerSlots, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_AMainLocalAttachment_C_Jig_CanChamberWeapon Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_CheckCanReload(class UActorComponent* MPComp, const struct FGameplayTag& PlayerSlots, bool* Result, class UJSIContainer_C** ContainerMag, class UAnimMontage** ReloadMontage, bool* HasInternalMag, bool* CanChamber_, class UJSI_Slot_C** ReloadWith, class UAnimMontage** LoopReloadAnim)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_AMainLocalAttachment_C_Jig_CheckCanReload Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_ExecuteChamberWeapon(class UActorComponent* MPComp, const struct FGameplayTag& PlayerSlots, bool* Result, class UAnimMontage** ChamberMontage, double* Speed)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_AMainLocalAttachment_C_Jig_ExecuteChamberWeapon Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_GetADSSocketLocation(struct FVector* SocketLoc, bool* SocketFound)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_AMainLocalAttachment_C_Jig_GetADSSocketLocation Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_GetAttachmentActiveState(struct FGameplayTag* Result)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AMainLocalAttachment_C", "Jig_GetAttachmentActiveState");

	Params::BP_AMainLocalAttachment_C_Jig_GetAttachmentActiveState Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_GetAttachmentArrayByType(const struct FGameplayTag& Type, TArray<class ABP_AMainLocalAttachment_C*>* Attachment, bool* Found)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AMainLocalAttachment_C", "Jig_GetAttachmentArrayByType");

	Params::BP_AMainLocalAttachment_C_Jig_GetAttachmentArrayByType Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_GetAttachmentByType(const struct FGameplayTag& Type, class ABP_AMainLocalAttachment_C** Attachment, bool* Found)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_AMainLocalAttachment_C_Jig_GetAttachmentByType Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_GetAttachmentInfo(struct FGuid* UID, class UJigsawItem_DataAsset_C** AttachmentInfo)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_AMainLocalAttachment_C_Jig_GetAttachmentInfo Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_GetAvailableAttachmentStates(struct FGameplayTagContainer* States)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AMainLocalAttachment_C", "Jig_GetAvailableAttachmentStates");

	Params::BP_AMainLocalAttachment_C_Jig_GetAvailableAttachmentStates Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_GetEquipMontage(bool CanChamber_, class UAnimMontage** EquipMontage)
{
	...
	Params::BP_AMainLocalAttachment_C_Jig_GetEquipMontage Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_GetPendingMag(bool FindMagIfNoPending_, class ABP_AMainLocalAttachment_C** MagRef)
{
	...
	Params::BP_AMainLocalAttachment_C_Jig_GetPendingMag Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_GetPrimitiveComponent(class UPrimitiveComponent** Comp)
{
	...
	Params::BP_AMainLocalAttachment_C_Jig_GetPrimitiveComponent Parms{};
...
// Function BP_AMainLocalAttachment.BP_AMainLocalAttachment_C.Jig_OnAttachmentSnapInspector
// (Public, BlueprintCallable, BlueprintEvent)

void ABP_AMainLocalAttachment_C::Jig_OnAttachmentSnapInspector()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AMainLocalAttachment_C", "Jig_OnAttachmentSnapInspector");
...
void ABP_AMainLocalAttachment_C::Jig_OnMontageNotify(class FName NotifyName)
{
	...
	Params::BP_AMainLocalAttachment_C_Jig_OnMontageNotify Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_SetAttachmentActiveState(const struct FGameplayTag& Value)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AMainLocalAttachment_C", "Jig_SetAttachmentActiveState");

	Params::BP_AMainLocalAttachment_C_Jig_SetAttachmentActiveState Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_SetAttachmentInfo(const struct FGuid& UID, class UJigsawItem_DataAsset_C* AttachmentInfo, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_AMainLocalAttachment_C_Jig_SetAttachmentInfo Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_SetAttachmentState(const TArray<struct FGuid>& UID, const struct FGameplayTag& NewState, bool PreExecuteClientSide_)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AMainLocalAttachment_C", "Jig_SetAttachmentState");

	Params::BP_AMainLocalAttachment_C_Jig_SetAttachmentState Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_SetPendingMag(class ABP_AMainLocalAttachment_C* MagRef, class UJigsawItem_DataAsset_C* DA, bool* Result)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AMainLocalAttachment_C", "Jig_SetPendingMag");

	Params::BP_AMainLocalAttachment_C_Jig_SetPendingMag Parms{};
...
void ABP_AMainLocalAttachment_C::Jig_StartReloading(class UActorComponent* MPCom, class UJSIContainer_C* MagContainer, class UJSI_Slot_C* WithMag, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_AMainLocalAttachment_C_Jig_StartReloading Parms{};
...
// Function BP_AMainLocalAttachment.BP_AMainLocalAttachment_C.Jig_ToggleAttachmentActiveState
// (Public, BlueprintCallable, BlueprintEvent)

void ABP_AMainLocalAttachment_C::Jig_ToggleAttachmentActiveState()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AMainLocalAttachment_C", "Jig_ToggleAttachmentActiveState");

	UObject::ProcessEvent(Func, nullptr);
}


// Function BP_AMainLocalAttachment.BP_AMainLocalAttachment_C.OnActiveStateChanged
// (BlueprintCallable, BlueprintEvent)

void ABP_AMainLocalAttachment_C::OnActiveStateChanged()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AMainLocalAttachment_C", "OnActiveStateChanged");
