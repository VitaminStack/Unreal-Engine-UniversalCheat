...
// BlueprintGeneratedClass BP_RiotHelmetPickup.BP_RiotHelmetPickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_RiotHelmetPickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_RiotHelmetPickup_C;              // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_RiotHelmetPickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_RiotHelmetPickup_C">();
	}
	static class ABP_RiotHelmetPickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_RiotHelmetPickup_C>();
	}
};
static_assert(alignof(ABP_RiotHelmetPickup_C) == 0x000008, "Wrong alignment on ABP_RiotHelmetPickup_C");
static_assert(sizeof(ABP_RiotHelmetPickup_C) == 0x000318, "Wrong size on ABP_RiotHelmetPickup_C");
static_assert(offsetof(ABP_RiotHelmetPickup_C, UberGraphFrame_BP_RiotHelmetPickup_C) == 0x000310, "Member 'ABP_RiotHelmetPickup_C::UberGraphFrame_BP_RiotHelmetPickup_C' has a wrong offset!");
