...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_Widget_Functions_C">();
	}
...
static_assert(alignof(UBP_Widget_Functions_C) == 0x000008, "Wrong alignment on UBP_Widget_Functions_C");
static_assert(sizeof(UBP_Widget_Functions_C) == 0x000028, "Wrong size on UBP_Widget_Functions_C");
