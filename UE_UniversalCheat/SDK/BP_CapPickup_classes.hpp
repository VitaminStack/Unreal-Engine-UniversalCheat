...
// BlueprintGeneratedClass BP_CapPickup.BP_CapPickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_CapPickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_CapPickup_C;                     // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_CapPickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_CapPickup_C">();
	}
	static class ABP_CapPickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_CapPickup_C>();
	}
};
static_assert(alignof(ABP_CapPickup_C) == 0x000008, "Wrong alignment on ABP_CapPickup_C");
static_assert(sizeof(ABP_CapPickup_C) == 0x000318, "Wrong size on ABP_CapPickup_C");
static_assert(offsetof(ABP_CapPickup_C, UberGraphFrame_BP_CapPickup_C) == 0x000310, "Member 'ABP_CapPickup_C::UberGraphFrame_BP_CapPickup_C' has a wrong offset!");
