...
// BlueprintGeneratedClass BP_AviatorsPickup.BP_AviatorsPickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_AviatorsPickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_AviatorsPickup_C;                // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_AviatorsPickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_AviatorsPickup_C">();
	}
	static class ABP_AviatorsPickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_AviatorsPickup_C>();
	}
};
static_assert(alignof(ABP_AviatorsPickup_C) == 0x000008, "Wrong alignment on ABP_AviatorsPickup_C");
static_assert(sizeof(ABP_AviatorsPickup_C) == 0x000318, "Wrong size on ABP_AviatorsPickup_C");
static_assert(offsetof(ABP_AviatorsPickup_C, UberGraphFrame_BP_AviatorsPickup_C) == 0x000310, "Member 'ABP_AviatorsPickup_C::UberGraphFrame_BP_AviatorsPickup_C' has a wrong offset!");
