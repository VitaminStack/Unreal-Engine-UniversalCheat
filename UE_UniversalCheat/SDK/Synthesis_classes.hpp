...
public:
	...
	uint8                                         Pad_904[0x6CC];                                    // 0x0904(0x06CC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_908[0x3D8];                                    // 0x0908(0x03D8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	TMulticastInlineDelegate<void(int32 TableIndex)> OnTableAltered;                                    // 0x0900(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnNumTablesChanged;                                // 0x0910(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_928[0x728];                                    // 0x0928(0x0728)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	TMulticastInlineDelegate<void()>              OnSampleLoaded;                                    // 0x0908(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(float ProgressPercent, float ProgressTimeSeconds)> OnSamplePlaybackProgress;                          // 0x0918(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_928[0x108];                                    // 0x0928(0x0108)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	TMulticastInlineDelegate<void(float Value)>   OnValueChangedX;                                   // 0x0640(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(float Value)>   OnValueChangedY;                                   // 0x0650(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
