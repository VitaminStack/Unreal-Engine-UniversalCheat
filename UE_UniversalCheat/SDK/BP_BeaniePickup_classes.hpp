...
// BlueprintGeneratedClass BP_BeaniePickup.BP_BeaniePickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_BeaniePickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_BeaniePickup_C;                  // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_BeaniePickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_BeaniePickup_C">();
	}
	static class ABP_BeaniePickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_BeaniePickup_C>();
	}
};
static_assert(alignof(ABP_BeaniePickup_C) == 0x000008, "Wrong alignment on ABP_BeaniePickup_C");
static_assert(sizeof(ABP_BeaniePickup_C) == 0x000318, "Wrong size on ABP_BeaniePickup_C");
static_assert(offsetof(ABP_BeaniePickup_C, UberGraphFrame_BP_BeaniePickup_C) == 0x000310, "Member 'ABP_BeaniePickup_C::UberGraphFrame_BP_BeaniePickup_C' has a wrong offset!");
