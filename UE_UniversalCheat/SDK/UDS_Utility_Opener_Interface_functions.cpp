...
void IUDS_Utility_Opener_Interface_C::Open_UDS_Readme(const class FString& Entry_Row, int32 Category_Index)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("UDS_Utility_Opener_Interface_C", "Open UDS Readme");
...
void IUDS_Utility_Opener_Interface_C::Open_UDS_Readme_Entry_Set(const TArray<class FName>& Entries)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("UDS_Utility_Opener_Interface_C", "Open UDS Readme Entry Set");
...
void IUDS_Utility_Opener_Interface_C::Show_Editor_Warning_Window(const class FString& Title, const class FString& Message)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("UDS_Utility_Opener_Interface_C", "Show Editor Warning Window");
