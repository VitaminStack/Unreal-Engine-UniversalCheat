...
static_assert(alignof(DiscordRpc_GetStartTimeStamp) == 0x000008, "Wrong alignment on DiscordRpc_GetStartTimeStamp");
static_assert(sizeof(DiscordRpc_GetStartTimeStamp) == 0x000008, "Wrong size on DiscordRpc_GetStartTimeStamp");
static_assert(offsetof(DiscordRpc_GetStartTimeStamp, ReturnValue) == 0x000000, "Member 'DiscordRpc_GetStartTimeStamp::ReturnValue' has a wrong offset!");
