...
#include "AI_SetBoolValue_classes.hpp"
#include "AI_SetBoolValue_parameters.hpp"
...
void UAI_SetBoolValue_C::ExecuteUbergraph_AI_SetBoolValue(int32 EntryPoint)
{
	...
	Params::AI_SetBoolValue_C_ExecuteUbergraph_AI_SetBoolValue Parms{};
...
void UAI_SetBoolValue_C::ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn)
{
	...
	Params::AI_SetBoolValue_C_ReceiveExecuteAI Parms{};
