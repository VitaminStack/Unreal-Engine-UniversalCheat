...
// BlueprintGeneratedClass BP_OilRigTacticalHelmetPickup.BP_OilRigTacticalHelmetPickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_OilRigTacticalHelmetPickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_OilRigTacticalHelmetPickup_C;    // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_OilRigTacticalHelmetPickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_OilRigTacticalHelmetPickup_C">();
	}
	static class ABP_OilRigTacticalHelmetPickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_OilRigTacticalHelmetPickup_C>();
	}
};
static_assert(alignof(ABP_OilRigTacticalHelmetPickup_C) == 0x000008, "Wrong alignment on ABP_OilRigTacticalHelmetPickup_C");
static_assert(sizeof(ABP_OilRigTacticalHelmetPickup_C) == 0x000318, "Wrong size on ABP_OilRigTacticalHelmetPickup_C");
static_assert(offsetof(ABP_OilRigTacticalHelmetPickup_C, UberGraphFrame_BP_OilRigTacticalHelmetPickup_C) == 0x000310, "Member 'ABP_OilRigTacticalHelmetPickup_C::UberGraphFrame_BP_OilRigTacticalHelmetPickup_C' has a wrong offset!");
