...
static_assert(alignof(DragonIKPhysicsComponent_Multicast_OnHitCallback) == 0x000004, "Wrong alignment on DragonIKPhysicsComponent_Multicast_OnHitCallback");
static_assert(sizeof(DragonIKPhysicsComponent_Multicast_OnHitCallback) == 0x000008, "Wrong size on DragonIKPhysicsComponent_Multicast_OnHitCallback");
static_assert(offsetof(DragonIKPhysicsComponent_Multicast_OnHitCallback, Optional_Override_Hit_Bone_Name) == 0x000000, "Member 'DragonIKPhysicsComponent_Multicast_OnHitCallback::Optional_Override_Hit_Bone_Name' has a wrong offset!");
...
static_assert(alignof(DragonIKPhysicsComponent_Server_OnHitCallback) == 0x000004, "Wrong alignment on DragonIKPhysicsComponent_Server_OnHitCallback");
...
static_assert(offsetof(DragonIKPhysicsComponent_Server_OnHitCallback, Optional_Override_Hit_Bone_Name) == 0x000000, "Member 'DragonIKPhysicsComponent_Server_OnHitCallback::Optional_Override_Hit_Bone_Name' has a wrong offset!");
...
static_assert(alignof(DragonIKPhysicsComponent_UpdateSpecificPhysanimData) == 0x000004, "Wrong alignment on DragonIKPhysicsComponent_UpdateSpecificPhysanimData");
static_assert(sizeof(DragonIKPhysicsComponent_UpdateSpecificPhysanimData) == 0x000018, "Wrong size on DragonIKPhysicsComponent_UpdateSpecificPhysanimData");
static_assert(offsetof(DragonIKPhysicsComponent_UpdateSpecificPhysanimData, BoneName) == 0x000000, "Member 'DragonIKPhysicsComponent_UpdateSpecificPhysanimData::BoneName' has a wrong offset!");
static_assert(offsetof(DragonIKPhysicsComponent_UpdateSpecificPhysanimData, linear_strength_var) == 0x000008, "Member 'DragonIKPhysicsComponent_UpdateSpecificPhysanimData::linear_strength_var' has a wrong offset!");
static_assert(offsetof(DragonIKPhysicsComponent_UpdateSpecificPhysanimData, angular_strength_var) == 0x00000C, "Member 'DragonIKPhysicsComponent_UpdateSpecificPhysanimData::angular_strength_var' has a wrong offset!");
static_assert(offsetof(DragonIKPhysicsComponent_UpdateSpecificPhysanimData, linear_damp_var) == 0x000010, "Member 'DragonIKPhysicsComponent_UpdateSpecificPhysanimData::linear_damp_var' has a wrong offset!");
static_assert(offsetof(DragonIKPhysicsComponent_UpdateSpecificPhysanimData, angular_damp_var) == 0x000014, "Member 'DragonIKPhysicsComponent_UpdateSpecificPhysanimData::angular_damp_var' has a wrong offset!");
...
static_assert(offsetof(DragonIKWeaponPhysicsComponent_Grab_Weapon, WeaponBoneName) == 0x00000C, "Member 'DragonIKWeaponPhysicsComponent_Grab_Weapon::WeaponBoneName' has a wrong offset!");
...
static_assert(sizeof(DragonIKWeaponPhysicsComponent_Multicast_Grab_Weapon) == 0x000014, "Wrong size on DragonIKWeaponPhysicsComponent_Multicast_Grab_Weapon");
...
static_assert(offsetof(DragonIKWeaponPhysicsComponent_Multicast_Grab_Weapon, WeaponBoneName) == 0x00000C, "Member 'DragonIKWeaponPhysicsComponent_Multicast_Grab_Weapon::WeaponBoneName' has a wrong offset!");
...
static_assert(offsetof(DragonIKWeaponPhysicsComponent_Server_Grab_Weapon, WeaponBoneName) == 0x00000C, "Member 'DragonIKWeaponPhysicsComponent_Server_Grab_Weapon::WeaponBoneName' has a wrong offset!");
