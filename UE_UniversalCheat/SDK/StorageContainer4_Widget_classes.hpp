...
class UStorageContainer4_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_StorageContainer4_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"StorageContainer4_Widget_C">();
	}
	static class UStorageContainer4_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UStorageContainer4_Widget_C>();
	}
};
static_assert(alignof(UStorageContainer4_Widget_C) == 0x000008, "Wrong alignment on UStorageContainer4_Widget_C");
static_assert(sizeof(UStorageContainer4_Widget_C) == 0x0002D0, "Wrong size on UStorageContainer4_Widget_C");
static_assert(offsetof(UStorageContainer4_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UStorageContainer4_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UStorageContainer4_Widget_C, MainContainer) == 0x0002C8, "Member 'UStorageContainer4_Widget_C::MainContainer' has a wrong offset!");
