...
// WidgetBlueprintGeneratedClass MilitarySupplyCratesContainer_Widget.MilitarySupplyCratesContainer_Widget_C
// 0x0010 (0x02D0 - 0x02C0)
class UMilitarySupplyCratesContainer_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_MilitarySupplyCratesContainer_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"MilitarySupplyCratesContainer_Widget_C">();
	}
	static class UMilitarySupplyCratesContainer_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMilitarySupplyCratesContainer_Widget_C>();
	}
};
static_assert(alignof(UMilitarySupplyCratesContainer_Widget_C) == 0x000008, "Wrong alignment on UMilitarySupplyCratesContainer_Widget_C");
static_assert(sizeof(UMilitarySupplyCratesContainer_Widget_C) == 0x0002D0, "Wrong size on UMilitarySupplyCratesContainer_Widget_C");
static_assert(offsetof(UMilitarySupplyCratesContainer_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UMilitarySupplyCratesContainer_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMilitarySupplyCratesContainer_Widget_C, MainContainer) == 0x0002C8, "Member 'UMilitarySupplyCratesContainer_Widget_C::MainContainer' has a wrong offset!");
