...
#include "GunLockerContainer_Widget_classes.hpp"
#include "GunLockerContainer_Widget_parameters.hpp"
...
void UGunLockerContainer_Widget_C::GetJSIContainerByPlayerSlots(const struct FGameplayTag& Slot_0, class UJSIContainer_C** Container, class UJSI_Slot_C** EquippedItem, bool* IsPending_)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GunLockerContainer_Widget_C", "GetJSIContainerByPlayerSlots");

	Params::GunLockerContainer_Widget_C_GetJSIContainerByPlayerSlots Parms{};
...
void UGunLockerContainer_Widget_C::GetListOfContainers(TArray<class UJSIContainer_C*>* Containers) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GunLockerContainer_Widget_C", "GetListOfContainers");

	Params::GunLockerContainer_Widget_C_GetListOfContainers Parms{};
