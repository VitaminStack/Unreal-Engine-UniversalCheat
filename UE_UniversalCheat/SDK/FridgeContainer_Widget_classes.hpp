...
class UFridgeContainer_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_FridgeContainer_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"FridgeContainer_Widget_C">();
	}
	static class UFridgeContainer_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UFridgeContainer_Widget_C>();
	}
};
static_assert(alignof(UFridgeContainer_Widget_C) == 0x000008, "Wrong alignment on UFridgeContainer_Widget_C");
static_assert(sizeof(UFridgeContainer_Widget_C) == 0x0002D0, "Wrong size on UFridgeContainer_Widget_C");
static_assert(offsetof(UFridgeContainer_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UFridgeContainer_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UFridgeContainer_Widget_C, MainContainer) == 0x0002C8, "Member 'UFridgeContainer_Widget_C::MainContainer' has a wrong offset!");
