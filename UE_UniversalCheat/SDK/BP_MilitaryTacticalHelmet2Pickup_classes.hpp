...
// BlueprintGeneratedClass BP_MilitaryTacticalHelmet2Pickup.BP_MilitaryTacticalHelmet2Pickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_MilitaryTacticalHelmet2Pickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_MilitaryTacticalHelmet2Pickup_C; // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_MilitaryTacticalHelmet2Pickup_C">();
	}
	static class ABP_MilitaryTacticalHelmet2Pickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_MilitaryTacticalHelmet2Pickup_C>();
	}
};
static_assert(alignof(ABP_MilitaryTacticalHelmet2Pickup_C) == 0x000008, "Wrong alignment on ABP_MilitaryTacticalHelmet2Pickup_C");
static_assert(sizeof(ABP_MilitaryTacticalHelmet2Pickup_C) == 0x000318, "Wrong size on ABP_MilitaryTacticalHelmet2Pickup_C");
static_assert(offsetof(ABP_MilitaryTacticalHelmet2Pickup_C, UberGraphFrame_BP_MilitaryTacticalHelmet2Pickup_C) == 0x000310, "Member 'ABP_MilitaryTacticalHelmet2Pickup_C::UberGraphFrame_BP_MilitaryTacticalHelmet2Pickup_C' has a wrong offset!");
