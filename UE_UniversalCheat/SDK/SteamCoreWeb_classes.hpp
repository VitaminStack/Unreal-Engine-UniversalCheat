...
{
public:
	TMulticastInlineDelegate<void(TArray<struct FWebAppsGetAppList>& Data, bool bWasSuccessful)> OnCallback;                                        // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	void AddItem(const TDelegate<void(const class FString& Data, bool bWasSuccessful)>& Callback, const class FString& Key, int32 AppID, const TArray<int32>& ItemdefId, const class FString& ItemPropsJson, const TArray<int32>& ItemQuantity, const class FString& SteamID, bool bNotify, const class FString& RequestID, bool bTradeRestriction);
	...
	void ExchangeItem(const TDelegate<void(const class FString& Data, bool bWasSuccessful)>& Callback, const class FString& Key, int32 AppID, const class FString& SteamID, const TArray<int64>& MaterialsItemID, const TArray<int32>& MaterialsQuantity, int64 OutputItemdefId);
	...
	void ModifyItems(const TDelegate<void(const class FString& Data, bool bWasSuccessful)>& Callback, const class FString& Key, int32 AppID, const class FString& SteamID, const struct FModifyItemsItem& Updates);
...
{
public:
	static class USteamCoreWebAsyncActionAddItem* AddItemAsync(class UObject* WorldContextObject, const class FString& Key, int32 AppID, const TArray<int32>& ItemdefId, const class FString& ItemPropsJson, const TArray<int32>& ItemQuantity, const class FString& SteamID, bool bNotify, const class FString& RequestID, bool bTradeRestriction);
...
{
public:
	static class USteamCoreWebAsyncActionExchangeItem* ExchangeItemAsync(class UObject* WorldContextObject, const class FString& Key, int32 AppID, const class FString& SteamID, const TArray<int64>& MaterialsItemID, const TArray<int32>& MaterialsQuantity, int64 OutputItemdefId);
...
{
public:
	static class USteamCoreWebAsyncActionModifyItems* ModifyItemsAsync(class UObject* WorldContextObject, const class FString& Key, int32 AppID, const class FString& SteamID, const struct FModifyItemsItem& Updates);
