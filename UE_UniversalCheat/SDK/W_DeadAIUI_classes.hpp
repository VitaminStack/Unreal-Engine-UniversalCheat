...
// WidgetBlueprintGeneratedClass W_DeadAIUI.W_DeadAIUI_C
// 0x0030 (0x02F0 - 0x02C0)
class UW_DeadAIUI_C final : public UUserWidget
{
public:
	...
	class UJSIContainer_C*                        JSIContainer;                                      // 0x02D0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UTextBlock*                             LootAllText;                                       // 0x02D8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"W_DeadAIUI_C">();
	}
	static class UW_DeadAIUI_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UW_DeadAIUI_C>();
	}
};
static_assert(alignof(UW_DeadAIUI_C) == 0x000008, "Wrong alignment on UW_DeadAIUI_C");
static_assert(sizeof(UW_DeadAIUI_C) == 0x0002F0, "Wrong size on UW_DeadAIUI_C");
static_assert(offsetof(UW_DeadAIUI_C, UberGraphFrame) == 0x0002C0, "Member 'UW_DeadAIUI_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UW_DeadAIUI_C, Button_66) == 0x0002C8, "Member 'UW_DeadAIUI_C::Button_66' has a wrong offset!");
static_assert(offsetof(UW_DeadAIUI_C, JSIContainer) == 0x0002D0, "Member 'UW_DeadAIUI_C::JSIContainer' has a wrong offset!");
static_assert(offsetof(UW_DeadAIUI_C, LootAllText) == 0x0002D8, "Member 'UW_DeadAIUI_C::LootAllText' has a wrong offset!");
static_assert(offsetof(UW_DeadAIUI_C, Array_Of_Items) == 0x0002E0, "Member 'UW_DeadAIUI_C::Array_Of_Items' has a wrong offset!");
