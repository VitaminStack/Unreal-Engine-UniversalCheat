...
// Function BP_MasterScavenger.BP_MasterScavenger_C.ExecuteUbergraph_BP_MasterScavenger
// 0x0620 (0x0620 - 0x0000)
struct BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger final
{
public:
	...
	TDelegate<void(float NewValue)>               K2Node_CreateDelegate_OutputDelegate;              // 0x0028(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	double                                        K2Node_Event_Speed;                                // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AController*                            K2Node_Event_InstigatedBy;                         // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Event_DamageCauser;                         // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<class FName>                           K2Node_MakeArray_Array;                            // 0x00E0(0x0010)(ReferenceParm)
	class UNarrativeComponent*                    CallFunc_GetNarrativeComponent_ReturnValue;        // 0x00F0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_CompleteNarrativeDataTask_ReturnValue;    // 0x00F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_F9[0x7];                                       // 0x00F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UWidgetComponent*                       K2Node_Event_Marker;                               // 0x0100(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_LineOfSightTo_ReturnValue;                // 0x0118(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_Burning_;                             // 0x0119(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_11A[0x6];                                      // 0x011A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        K2Node_Event_Dmg;                                  // 0x0120(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Array_Get_Item_1;                         // 0x0170(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Array_Get_Item_2;                         // 0x0188(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_Array_Get_Item_3;                         // 0x0190(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TMap<E_AIBehaviour, double>                   K2Node_MakeMap_Map;                                // 0x01B0(0x0050)()
	TArray<double>                                CallFunc_Map_Values_Values_1;                      // 0x0200(0x0010)(ReferenceParm)
	...
	double                                        CallFunc_Array_Get_Item_4;                         // 0x0218(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Array_Get_Item_6;                         // 0x0238(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TMap<E_AIBehaviour, double>                   K2Node_MakeMap_Map_1;                              // 0x0260(0x0050)()
	...
	TMap<struct FGameplayTag, class FText>        K2Node_MakeMap_Map_4;                              // 0x03F8(0x0050)(ConstParm)
	bool                                          CallFunc_GetBoolCVar_ReturnValue;                  // 0x0448(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_449[0x7];                                      // 0x0449(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AHUD_Game_C*                            CallFunc_GetHUD_HUD;                               // 0x0450(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AHUD_Game_C*                            CallFunc_GetHUD_HUD_1;                             // 0x0458(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UWidget*                                CallFunc_ShowInteractWidget_Widget;                // 0x0460(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_1;            // 0x051C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UUserWidget*                            CallFunc_SetupInventoryWidget_InventoryWidgetRef;  // 0x0538(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FTransform                             Temp_struct_Variable;                              // 0x0540(0x0060)(ConstParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_AddJigWidgetToContent_Result;             // 0x05A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_2;            // 0x05D4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FAIOSubjectHandle                      CallFunc_K2_DespawnSubject_SubjectHandle;          // 0x05F0(0x0004)(NoDestructor)
	bool                                          CallFunc_K2_DespawnSubject_ReturnValue;            // 0x05F4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger) == 0x000010, "Wrong alignment on BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger");
static_assert(sizeof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger) == 0x000620, "Wrong size on BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, EntryPoint) == 0x000000, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::EntryPoint' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_ComponentBoundEvent_bIsBeyondLastLayer) == 0x000004, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_ComponentBoundEvent_bIsBeyondLastLayer' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_ComponentBoundEvent_LayerIndex) == 0x000008, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_ComponentBoundEvent_LayerIndex' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_ComponentBoundEvent_bIsSeen) == 0x00000C, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_ComponentBoundEvent_bIsSeen' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_SwitchInteger_CmpSuccess) == 0x00000D, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_SwitchInteger_CmpSuccess' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_GetWorldSubsystem_ReturnValue) == 0x000010, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_GetWorldSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, Temp_bool_Has_Been_Initd_Variable) == 0x000018, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, Temp_int_Loop_Counter_Variable) == 0x00001C, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Add_IntInt_ReturnValue) == 0x000020, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, Temp_int_Array_Index_Variable) == 0x000024, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_CreateDelegate_OutputDelegate) == 0x000028, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Speed) == 0x000038, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Speed' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Direction) == 0x000040, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Direction' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Name) == 0x000058, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Name' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_InteractingActor_3) == 0x000068, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_InteractingActor_3' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Option_2) == 0x000070, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Option_2' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_ByActor) == 0x000078, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_ByActor' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Payload) == 0x000080, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Payload' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_InteractingActor_2) == 0x0000B0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_InteractingActor_2' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Option_1) == 0x0000B8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Option_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Damage) == 0x0000C0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Damage' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_DamageType) == 0x0000C8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_DamageType' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_InstigatedBy) == 0x0000D0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_InstigatedBy' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_DamageCauser) == 0x0000D8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_DamageCauser' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_MakeArray_Array) == 0x0000E0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_GetNarrativeComponent_ReturnValue) == 0x0000F0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_GetNarrativeComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_CompleteNarrativeDataTask_ReturnValue) == 0x0000F8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_CompleteNarrativeDataTask_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Marker) == 0x000100, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Marker' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_GetPlayerController_ReturnValue) == 0x000108, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_GetPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_GetAIController_ReturnValue) == 0x000110, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_GetAIController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_LineOfSightTo_ReturnValue) == 0x000118, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_LineOfSightTo_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Burning_) == 0x000119, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Burning_' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Dmg) == 0x000120, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Dmg' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Actor) == 0x000128, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Actor' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_IsValid_ReturnValue) == 0x000130, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_RandomFloatInRange_ReturnValue) == 0x000138, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, Temp_text_Variable) == 0x000140, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::Temp_text_Variable' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Map_Values_Values) == 0x000158, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Map_Values_Values' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Array_Get_Item) == 0x000168, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Array_Get_Item_1) == 0x000170, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000178, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Divide_DoubleDouble_ReturnValue_1) == 0x000180, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Divide_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Array_Get_Item_2) == 0x000188, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Array_Get_Item_3) == 0x000190, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Array_Get_Item_3' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Divide_DoubleDouble_ReturnValue_2) == 0x000198, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Divide_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Divide_DoubleDouble_ReturnValue_3) == 0x0001A0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Divide_DoubleDouble_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, Temp_bool_Variable) == 0x0001A8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_MakeMap_Map) == 0x0001B0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_MakeMap_Map' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Map_Values_Values_1) == 0x000200, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Map_Values_Values_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_ApplyDamage_ReturnValue) == 0x000210, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_ApplyDamage_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Array_Get_Item_4) == 0x000218, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Array_Get_Item_4' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Array_Get_Item_5) == 0x000220, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Array_Get_Item_5' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000228, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Multiply_DoubleDouble_ReturnValue_1) == 0x000230, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Multiply_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Array_Get_Item_6) == 0x000238, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Array_Get_Item_6' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Array_Get_Item_7) == 0x000240, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Array_Get_Item_7' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Multiply_DoubleDouble_ReturnValue_2) == 0x000248, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Multiply_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Multiply_DoubleDouble_ReturnValue_3) == 0x000250, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Multiply_DoubleDouble_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, Temp_bool_IsClosed_Variable) == 0x000258, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_MakeMap_Map_1) == 0x000260, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_MakeMap_Map_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_MakeLiteralText_ReturnValue) == 0x0002B0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_MakeStruct_FormatArgumentData) == 0x0002C8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_MakeArray_Array_1) == 0x000318, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_MakeMap_Map_2) == 0x000328, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_MakeMap_Map_2' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Format_ReturnValue) == 0x000378, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_MakeMap_Map_3) == 0x000390, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_MakeMap_Map_3' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Select_Default) == 0x0003E0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_MakeMap_Map_4) == 0x0003F8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_MakeMap_Map_4' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_GetBoolCVar_ReturnValue) == 0x000448, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_GetBoolCVar_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_GetHUD_HUD) == 0x000450, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_GetHUD_HUD' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_GetHUD_HUD_1) == 0x000458, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_GetHUD_HUD_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_ShowInteractWidget_Widget) == 0x000460, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_ShowInteractWidget_Widget' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_InteractingActor_1) == 0x000468, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_InteractingActor_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Options) == 0x000470, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Options' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_InteractingActor) == 0x0004C0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_InteractingActor' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_Event_Option) == 0x0004C8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_Event_Option' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_ShowInteractWidget_Widget_1) == 0x0004D0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_ShowInteractWidget_Widget_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_DynamicCast_AsBP_Jig_Character_Interface) == 0x0004D8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_DynamicCast_AsBP_Jig_Character_Interface' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_DynamicCast_bSuccess) == 0x0004E8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_DynamicCast_AsBP_Jig_Character_Interface_1) == 0x0004F0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_DynamicCast_AsBP_Jig_Character_Interface_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_DynamicCast_bSuccess_1) == 0x000500, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_K2_SetTimer_ReturnValue) == 0x000508, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_K2_SetTimer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_K2_SetTimer_ReturnValue_1) == 0x000510, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_K2_SetTimer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_RequestServerData_Result) == 0x000518, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_RequestServerData_Result' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_CreateDelegate_OutputDelegate_1) == 0x00051C, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000530, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_SetupInventoryWidget_InventoryWidgetRef) == 0x000538, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_SetupInventoryWidget_InventoryWidgetRef' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, Temp_struct_Variable) == 0x000540, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::Temp_struct_Variable' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_AddJigWidgetToContent_Result) == 0x0005A0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_AddJigWidgetToContent_Result' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_AddComponent_ReturnValue) == 0x0005A8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_AddComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Conv_IntToDouble_ReturnValue) == 0x0005B0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_CustomEvent_NewValue) == 0x0005B8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_CustomEvent_NewValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Multiply_DoubleDouble_ReturnValue_4) == 0x0005C0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Multiply_DoubleDouble_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_ScalingHealthMultiplier_NewMaxHealth) == 0x0005C8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_ScalingHealthMultiplier_NewMaxHealth' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_FTrunc_ReturnValue) == 0x0005D0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, K2Node_CreateDelegate_OutputDelegate_2) == 0x0005D4, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_K2_SetTimerDelegate_ReturnValue_1) == 0x0005E8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_K2_SetTimerDelegate_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_K2_DespawnSubject_SubjectHandle) == 0x0005F0, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_K2_DespawnSubject_SubjectHandle' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_K2_DespawnSubject_ReturnValue) == 0x0005F4, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_K2_DespawnSubject_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Array_Get_Item_8) == 0x0005F8, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Array_Get_Item_8' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Array_Length_ReturnValue) == 0x000608, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Less_IntInt_ReturnValue) == 0x00060C, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_ApplyDamage_BaseDamage_ImplicitCast) == 0x000610, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_ApplyDamage_BaseDamage_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Delay_Duration_ImplicitCast) == 0x000614, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x000618, "Member 'BP_MasterScavenger_C_ExecuteUbergraph_BP_MasterScavenger::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.GetInteractOptions
// 0x0050 (0x0050 - 0x0000)
struct BP_MasterScavenger_C_GetInteractOptions final
{
public:
	TMap<struct FGameplayTag, class FText>        Options;                                           // 0x0000(0x0050)(Parm, OutParm)
};
static_assert(alignof(BP_MasterScavenger_C_GetInteractOptions) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_GetInteractOptions");
static_assert(sizeof(BP_MasterScavenger_C_GetInteractOptions) == 0x000050, "Wrong size on BP_MasterScavenger_C_GetInteractOptions");
static_assert(offsetof(BP_MasterScavenger_C_GetInteractOptions, Options) == 0x000000, "Member 'BP_MasterScavenger_C_GetInteractOptions::Options' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.GetItemInfo
// 0x0078 (0x0078 - 0x0000)
struct BP_MasterScavenger_C_GetItemInfo final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_GetItemInfo) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_GetItemInfo");
static_assert(sizeof(BP_MasterScavenger_C_GetItemInfo) == 0x000078, "Wrong size on BP_MasterScavenger_C_GetItemInfo");
static_assert(offsetof(BP_MasterScavenger_C_GetItemInfo, Info) == 0x000000, "Member 'BP_MasterScavenger_C_GetItemInfo::Info' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_GetItemInfo, Count) == 0x000008, "Member 'BP_MasterScavenger_C_GetItemInfo::Count' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_GetItemInfo, RandomStatsConfig) == 0x000010, "Member 'BP_MasterScavenger_C_GetItemInfo::RandomStatsConfig' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_GetItemInfo, CustomData) == 0x000028, "Member 'BP_MasterScavenger_C_GetItemInfo::CustomData' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.GetJigMultiplayerComponent
// 0x0008 (0x0008 - 0x0000)
struct BP_MasterScavenger_C_GetJigMultiplayerComponent final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_GetJigMultiplayerComponent) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_GetJigMultiplayerComponent");
static_assert(sizeof(BP_MasterScavenger_C_GetJigMultiplayerComponent) == 0x000008, "Wrong size on BP_MasterScavenger_C_GetJigMultiplayerComponent");
static_assert(offsetof(BP_MasterScavenger_C_GetJigMultiplayerComponent, JigComp) == 0x000000, "Member 'BP_MasterScavenger_C_GetJigMultiplayerComponent::JigComp' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.GetMainSceneComp
// 0x0008 (0x0008 - 0x0000)
struct BP_MasterScavenger_C_GetMainSceneComp final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_GetMainSceneComp) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_GetMainSceneComp");
static_assert(sizeof(BP_MasterScavenger_C_GetMainSceneComp) == 0x000008, "Wrong size on BP_MasterScavenger_C_GetMainSceneComp");
static_assert(offsetof(BP_MasterScavenger_C_GetMainSceneComp, Comp) == 0x000000, "Member 'BP_MasterScavenger_C_GetMainSceneComp::Comp' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.GetMarker
// 0x0020 (0x0020 - 0x0000)
struct BP_MasterScavenger_C_GetMarker final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_GetMarker) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_GetMarker");
static_assert(sizeof(BP_MasterScavenger_C_GetMarker) == 0x000020, "Wrong size on BP_MasterScavenger_C_GetMarker");
static_assert(offsetof(BP_MasterScavenger_C_GetMarker, Texture) == 0x000000, "Member 'BP_MasterScavenger_C_GetMarker::Texture' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_GetMarker, Color) == 0x000008, "Member 'BP_MasterScavenger_C_GetMarker::Color' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_GetMarker, MarkerOffset) == 0x000018, "Member 'BP_MasterScavenger_C_GetMarker::MarkerOffset' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.GetMesh
// 0x0008 (0x0008 - 0x0000)
struct BP_MasterScavenger_C_GetMesh final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_GetMesh) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_GetMesh");
static_assert(sizeof(BP_MasterScavenger_C_GetMesh) == 0x000008, "Wrong size on BP_MasterScavenger_C_GetMesh");
static_assert(offsetof(BP_MasterScavenger_C_GetMesh, Mesh_0) == 0x000000, "Member 'BP_MasterScavenger_C_GetMesh::Mesh_0' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.GetMovementSpeeds
// 0x0018 (0x0018 - 0x0000)
struct BP_MasterScavenger_C_GetMovementSpeeds final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_GetMovementSpeeds) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_GetMovementSpeeds");
static_assert(sizeof(BP_MasterScavenger_C_GetMovementSpeeds) == 0x000018, "Wrong size on BP_MasterScavenger_C_GetMovementSpeeds");
static_assert(offsetof(BP_MasterScavenger_C_GetMovementSpeeds, RoamingSpeed) == 0x000000, "Member 'BP_MasterScavenger_C_GetMovementSpeeds::RoamingSpeed' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_GetMovementSpeeds, AlertSpeed) == 0x000008, "Member 'BP_MasterScavenger_C_GetMovementSpeeds::AlertSpeed' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_GetMovementSpeeds, AttackSpeed) == 0x000010, "Member 'BP_MasterScavenger_C_GetMovementSpeeds::AttackSpeed' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.HealthMultiplier
// 0x0004 (0x0004 - 0x0000)
struct BP_MasterScavenger_C_HealthMultiplier final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_HitByVehicle) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_HitByVehicle");
static_assert(sizeof(BP_MasterScavenger_C_HitByVehicle) == 0x000020, "Wrong size on BP_MasterScavenger_C_HitByVehicle");
static_assert(offsetof(BP_MasterScavenger_C_HitByVehicle, Speed) == 0x000000, "Member 'BP_MasterScavenger_C_HitByVehicle::Speed' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_HitByVehicle, Direction) == 0x000008, "Member 'BP_MasterScavenger_C_HitByVehicle::Direction' has a wrong offset!");
...
// Function BP_MasterScavenger.BP_MasterScavenger_C.JigCanInteract
// 0x0001 (0x0001 - 0x0000)
struct BP_MasterScavenger_C_JigCanInteract final
{
public:
	bool                                          Result;                                            // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_MasterScavenger_C_JigCanInteract) == 0x000001, "Wrong alignment on BP_MasterScavenger_C_JigCanInteract");
...
// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_GetLootWidget
// 0x0010 (0x0010 - 0x0000)
struct BP_MasterScavenger_C_JigMP_GetLootWidget final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_GetLootWidget) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_JigMP_GetLootWidget");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_GetLootWidget) == 0x000010, "Wrong size on BP_MasterScavenger_C_JigMP_GetLootWidget");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_GetLootWidget, Result) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_GetLootWidget::Result' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_GetLootWidget, Valid_) == 0x000008, "Member 'BP_MasterScavenger_C_JigMP_GetLootWidget::Valid_' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnContainersSwap
// 0x0018 (0x0018 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnContainersSwap final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnContainersSwap) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnContainersSwap");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnContainersSwap) == 0x000018, "Wrong size on BP_MasterScavenger_C_JigMP_OnContainersSwap");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnContainersSwap, Container1) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnContainersSwap::Container1' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnContainersSwap, Container2) == 0x000008, "Member 'BP_MasterScavenger_C_JigMP_OnContainersSwap::Container2' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnContainersSwap, Result) == 0x000010, "Member 'BP_MasterScavenger_C_JigMP_OnContainersSwap::Result' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnItemAdded
// 0x0040 (0x0040 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnItemAdded final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnItemAdded) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnItemAdded");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnItemAdded) == 0x000040, "Wrong size on BP_MasterScavenger_C_JigMP_OnItemAdded");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemAdded, ItemUID) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnItemAdded::ItemUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemAdded, FromContainerUID) == 0x000010, "Member 'BP_MasterScavenger_C_JigMP_OnItemAdded::FromContainerUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemAdded, ToContainerUID) == 0x000020, "Member 'BP_MasterScavenger_C_JigMP_OnItemAdded::ToContainerUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemAdded, FromComponent) == 0x000030, "Member 'BP_MasterScavenger_C_JigMP_OnItemAdded::FromComponent' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemAdded, Result) == 0x000038, "Member 'BP_MasterScavenger_C_JigMP_OnItemAdded::Result' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnItemConsumed
// 0x0118 (0x0118 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnItemConsumed final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnItemConsumed) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnItemConsumed");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnItemConsumed) == 0x000118, "Wrong size on BP_MasterScavenger_C_JigMP_OnItemConsumed");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemConsumed, ConsumedItem) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnItemConsumed::ConsumedItem' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemConsumed, Amount) == 0x000078, "Member 'BP_MasterScavenger_C_JigMP_OnItemConsumed::Amount' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemConsumed, Remaining) == 0x00007C, "Member 'BP_MasterScavenger_C_JigMP_OnItemConsumed::Remaining' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemConsumed, InsideOf) == 0x000080, "Member 'BP_MasterScavenger_C_JigMP_OnItemConsumed::InsideOf' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemConsumed, FromContainer) == 0x0000F8, "Member 'BP_MasterScavenger_C_JigMP_OnItemConsumed::FromContainer' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemConsumed, CustomData) == 0x000100, "Member 'BP_MasterScavenger_C_JigMP_OnItemConsumed::CustomData' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemConsumed, CallbackToPlayer_) == 0x000110, "Member 'BP_MasterScavenger_C_JigMP_OnItemConsumed::CallbackToPlayer_' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemConsumed, Result) == 0x000111, "Member 'BP_MasterScavenger_C_JigMP_OnItemConsumed::Result' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnItemDropped
// 0x0030 (0x0030 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnItemDropped final
{
public:
	struct FGuid                                  ItemUID;                                           // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  FromContainerUID;                                  // 0x0010(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnItemDropped) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnItemDropped");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnItemDropped) == 0x000030, "Wrong size on BP_MasterScavenger_C_JigMP_OnItemDropped");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemDropped, ItemUID) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnItemDropped::ItemUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemDropped, FromContainerUID) == 0x000010, "Member 'BP_MasterScavenger_C_JigMP_OnItemDropped::FromContainerUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemDropped, ActorRef) == 0x000020, "Member 'BP_MasterScavenger_C_JigMP_OnItemDropped::ActorRef' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemDropped, Result) == 0x000028, "Member 'BP_MasterScavenger_C_JigMP_OnItemDropped::Result' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnItemMoved
// 0x0034 (0x0034 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnItemMoved final
{
public:
	struct FGuid                                  ItemUID;                                           // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  FromContainerUID;                                  // 0x0010(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnItemMoved) == 0x000004, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnItemMoved");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnItemMoved) == 0x000034, "Wrong size on BP_MasterScavenger_C_JigMP_OnItemMoved");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemMoved, ItemUID) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnItemMoved::ItemUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemMoved, FromContainerUID) == 0x000010, "Member 'BP_MasterScavenger_C_JigMP_OnItemMoved::FromContainerUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemMoved, ToContainerUID) == 0x000020, "Member 'BP_MasterScavenger_C_JigMP_OnItemMoved::ToContainerUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemMoved, Result) == 0x000030, "Member 'BP_MasterScavenger_C_JigMP_OnItemMoved::Result' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnItemRemoved
// 0x0040 (0x0040 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnItemRemoved final
{
public:
	struct FGuid                                  ItemUID;                                           // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  FromContainerUID;                                  // 0x0010(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnItemRemoved) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnItemRemoved");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnItemRemoved) == 0x000040, "Wrong size on BP_MasterScavenger_C_JigMP_OnItemRemoved");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemRemoved, ItemUID) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnItemRemoved::ItemUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemRemoved, FromContainerUID) == 0x000010, "Member 'BP_MasterScavenger_C_JigMP_OnItemRemoved::FromContainerUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemRemoved, ToContainerUID) == 0x000020, "Member 'BP_MasterScavenger_C_JigMP_OnItemRemoved::ToContainerUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemRemoved, ToComponent) == 0x000030, "Member 'BP_MasterScavenger_C_JigMP_OnItemRemoved::ToComponent' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnItemRemoved, Result) == 0x000038, "Member 'BP_MasterScavenger_C_JigMP_OnItemRemoved::Result' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnMainContainerItemAdded
// 0x00B8 (0x00B8 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded) == 0x0000B8, "Wrong size on BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded, ToContainerUID) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded::ToContainerUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded, ItemUID) == 0x000010, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded::ItemUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded, ToContainerName) == 0x000020, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded::ToContainerName' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded, ItemInfo) == 0x000028, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded::ItemInfo' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded, FromMain) == 0x0000A0, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded::FromMain' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded, Result) == 0x0000A8, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded::Result' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded, ActorRef) == 0x0000B0, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemAdded::ActorRef' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnMainContainerItemRemoved
// 0x00A8 (0x00A8 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved) == 0x0000A8, "Wrong size on BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved, FromContainerUID) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved::FromContainerUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved, ItemUID) == 0x000010, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved::ItemUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved, ContainerName) == 0x000020, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved::ContainerName' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved, ItemRemovedInfo) == 0x000028, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved::ItemRemovedInfo' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved, Result) == 0x0000A0, "Member 'BP_MasterScavenger_C_JigMP_OnMainContainerItemRemoved::Result' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnPickupAdded
// 0x00A8 (0x00A8 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnPickupAdded final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnPickupAdded) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnPickupAdded");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnPickupAdded) == 0x0000A8, "Wrong size on BP_MasterScavenger_C_JigMP_OnPickupAdded");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupAdded, Info) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnPickupAdded::Info' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupAdded, ItemUID) == 0x000078, "Member 'BP_MasterScavenger_C_JigMP_OnPickupAdded::ItemUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupAdded, ToContainerUID) == 0x000088, "Member 'BP_MasterScavenger_C_JigMP_OnPickupAdded::ToContainerUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupAdded, ToContainer) == 0x000098, "Member 'BP_MasterScavenger_C_JigMP_OnPickupAdded::ToContainer' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupAdded, Result) == 0x0000A0, "Member 'BP_MasterScavenger_C_JigMP_OnPickupAdded::Result' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnPickupEquipped
// 0x00B8 (0x00B8 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnPickupEquipped final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnPickupEquipped) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnPickupEquipped");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnPickupEquipped) == 0x0000B8, "Wrong size on BP_MasterScavenger_C_JigMP_OnPickupEquipped");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupEquipped, ActorRef) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnPickupEquipped::ActorRef' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupEquipped, ToContainerName) == 0x000008, "Member 'BP_MasterScavenger_C_JigMP_OnPickupEquipped::ToContainerName' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupEquipped, UID) == 0x000010, "Member 'BP_MasterScavenger_C_JigMP_OnPickupEquipped::UID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupEquipped, ToContainerUID) == 0x000020, "Member 'BP_MasterScavenger_C_JigMP_OnPickupEquipped::ToContainerUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupEquipped, Info) == 0x000030, "Member 'BP_MasterScavenger_C_JigMP_OnPickupEquipped::Info' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupEquipped, Result) == 0x0000A8, "Member 'BP_MasterScavenger_C_JigMP_OnPickupEquipped::Result' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnPickupEquipped, OverrideActor) == 0x0000B0, "Member 'BP_MasterScavenger_C_JigMP_OnPickupEquipped::OverrideActor' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnRequestDropItem
// 0x0150 (0x0150 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnRequestDropItem final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnRequestDropItem) == 0x000010, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnRequestDropItem");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnRequestDropItem) == 0x000150, "Wrong size on BP_MasterScavenger_C_JigMP_OnRequestDropItem");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnRequestDropItem, ItemInfo) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnRequestDropItem::ItemInfo' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnRequestDropItem, ContainerName) == 0x000078, "Member 'BP_MasterScavenger_C_JigMP_OnRequestDropItem::ContainerName' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnRequestDropItem, ActorRef) == 0x000080, "Member 'BP_MasterScavenger_C_JigMP_OnRequestDropItem::ActorRef' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnRequestDropItem, CallFunc_GetPlayerCharacter_ReturnValue) == 0x000088, "Member 'BP_MasterScavenger_C_JigMP_OnRequestDropItem::CallFunc_GetPlayerCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnRequestDropItem, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000090, "Member 'BP_MasterScavenger_C_JigMP_OnRequestDropItem::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnRequestDropItem, CallFunc_RandomFloatInRange_ReturnValue) == 0x0000A8, "Member 'BP_MasterScavenger_C_JigMP_OnRequestDropItem::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnRequestDropItem, CallFunc_MakeRotator_ReturnValue) == 0x0000B0, "Member 'BP_MasterScavenger_C_JigMP_OnRequestDropItem::CallFunc_MakeRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnRequestDropItem, CallFunc_MakeTransform_ReturnValue) == 0x0000D0, "Member 'BP_MasterScavenger_C_JigMP_OnRequestDropItem::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnRequestDropItem, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x000130, "Member 'BP_MasterScavenger_C_JigMP_OnRequestDropItem::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnRequestDropItem, CallFunc_FinishSpawningActor_ReturnValue) == 0x000138, "Member 'BP_MasterScavenger_C_JigMP_OnRequestDropItem::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnRequestDropItem, CallFunc_MakeRotator_Yaw_ImplicitCast) == 0x000140, "Member 'BP_MasterScavenger_C_JigMP_OnRequestDropItem::CallFunc_MakeRotator_Yaw_ImplicitCast' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnTwoContainersSwap
// 0x0014 (0x0014 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnTwoContainersSwap final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnTwoContainersSwap) == 0x000004, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnTwoContainersSwap");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnTwoContainersSwap) == 0x000014, "Wrong size on BP_MasterScavenger_C_JigMP_OnTwoContainersSwap");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnTwoContainersSwap, FromContainer) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnTwoContainersSwap::FromContainer' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnTwoContainersSwap, ToContainer) == 0x000008, "Member 'BP_MasterScavenger_C_JigMP_OnTwoContainersSwap::ToContainer' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnTwoContainersSwap, Result) == 0x000010, "Member 'BP_MasterScavenger_C_JigMP_OnTwoContainersSwap::Result' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigMP_OnUpdateChamberUID
// 0x0014 (0x0014 - 0x0000)
struct BP_MasterScavenger_C_JigMP_OnUpdateChamberUID final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigMP_OnUpdateChamberUID) == 0x000004, "Wrong alignment on BP_MasterScavenger_C_JigMP_OnUpdateChamberUID");
static_assert(sizeof(BP_MasterScavenger_C_JigMP_OnUpdateChamberUID) == 0x000014, "Wrong size on BP_MasterScavenger_C_JigMP_OnUpdateChamberUID");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnUpdateChamberUID, NewUID) == 0x000000, "Member 'BP_MasterScavenger_C_JigMP_OnUpdateChamberUID::NewUID' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigMP_OnUpdateChamberUID, Result) == 0x000010, "Member 'BP_MasterScavenger_C_JigMP_OnUpdateChamberUID::Result' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.JigSetCanInteract
// 0x0003 (0x0003 - 0x0000)
struct BP_MasterScavenger_C_JigSetCanInteract final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_JigSetCanInteract) == 0x000001, "Wrong alignment on BP_MasterScavenger_C_JigSetCanInteract");
static_assert(sizeof(BP_MasterScavenger_C_JigSetCanInteract) == 0x000003, "Wrong size on BP_MasterScavenger_C_JigSetCanInteract");
static_assert(offsetof(BP_MasterScavenger_C_JigSetCanInteract, CanInteract) == 0x000000, "Member 'BP_MasterScavenger_C_JigSetCanInteract::CanInteract' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigSetCanInteract, EnablePhysics) == 0x000001, "Member 'BP_MasterScavenger_C_JigSetCanInteract::EnablePhysics' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_JigSetCanInteract, Result) == 0x000002, "Member 'BP_MasterScavenger_C_JigSetCanInteract::Result' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.OnBeginInteract
// 0x0058 (0x0058 - 0x0000)
struct BP_MasterScavenger_C_OnBeginInteract final
{
public:
...
static_assert(alignof(BP_MasterScavenger_C_OnBeginInteract) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_OnBeginInteract");
static_assert(sizeof(BP_MasterScavenger_C_OnBeginInteract) == 0x000058, "Wrong size on BP_MasterScavenger_C_OnBeginInteract");
static_assert(offsetof(BP_MasterScavenger_C_OnBeginInteract, InteractingActor) == 0x000000, "Member 'BP_MasterScavenger_C_OnBeginInteract::InteractingActor' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_OnBeginInteract, Options) == 0x000008, "Member 'BP_MasterScavenger_C_OnBeginInteract::Options' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.OnExecuteInteract
// 0x0010 (0x0010 - 0x0000)
struct BP_MasterScavenger_C_OnExecuteInteract final
{
public:
	class AActor*                                 InteractingActor;                                  // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           Option;                                            // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_MasterScavenger_C_OnExecuteInteract) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_OnExecuteInteract");
static_assert(sizeof(BP_MasterScavenger_C_OnExecuteInteract) == 0x000010, "Wrong size on BP_MasterScavenger_C_OnExecuteInteract");
static_assert(offsetof(BP_MasterScavenger_C_OnExecuteInteract, InteractingActor) == 0x000000, "Member 'BP_MasterScavenger_C_OnExecuteInteract::InteractingActor' has a wrong offset!");
static_assert(offsetof(BP_MasterScavenger_C_OnExecuteInteract, Option) == 0x000008, "Member 'BP_MasterScavenger_C_OnExecuteInteract::Option' has a wrong offset!");

// Function BP_MasterScavenger.BP_MasterScavenger_C.OnExecuteInteractDialogue
// 0x0008 (0x0008 - 0x0000)
struct BP_MasterScavenger_C_OnExecuteInteractDialogue final
{
public:
	class AActor*                                 InteractingActor;                                  // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_MasterScavenger_C_OnExecuteInteractDialogue) == 0x000008, "Wrong alignment on BP_MasterScavenger_C_OnExecuteInteractDialogue");
static_assert(sizeof(BP_MasterScavenger_C_OnExecuteInteractDialogue) == 0x000008, "Wrong size on BP_MasterScavenger_C_OnExecuteInteractDialogue");
static_assert(offsetof(BP_MasterScavenger_C_OnExecuteInteractDialogue, InteractingActor) == 0x000000, "Member 'BP_MasterScavenger_C_OnExecuteInteractDialogue::InteractingActor' has a wrong offset!");
