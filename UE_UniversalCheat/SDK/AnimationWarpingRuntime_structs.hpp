...
static_assert(sizeof(FAnimNode_FootPlacement) == 0x000410, "Wrong size on FAnimNode_FootPlacement");
...
static_assert(sizeof(FAnimNode_StrideWarping) == 0x000248, "Wrong size on FAnimNode_StrideWarping");
...
static_assert(offsetof(FAnimNode_StrideWarping, bOrientStrideDirectionUsingFloorNormal) == 0x000200, "Member 'FAnimNode_StrideWarping::bOrientStrideDirectionUsingFloorNormal' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, bCompensateIKUsingFKThighRotation) == 0x000201, "Member 'FAnimNode_StrideWarping::bCompensateIKUsingFKThighRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, bClampIKUsingFKLimits) == 0x000202, "Member 'FAnimNode_StrideWarping::bClampIKUsingFKLimits' has a wrong offset!");
