...
#include "TechTree_parameters.hpp"
...
class FString UTechnologyTree::GetTechAssetName()
{
	...
	Params::TechnologyTree_GetTechAssetName Parms{};
...
bool UTechnologyTree::HasUnlockedParents(class UTechnologyAsset* Technology)
{
	...
	Params::TechnologyTree_HasUnlockedParents Parms{};
...
bool UTechnologyTree::IsTechnologyUnlocked(class UTechnologyAsset* Technology)
{
	...
	Params::TechnologyTree_IsTechnologyUnlocked Parms{};
...
TArray<struct FTechNodeLink> UTechnologyTree::FilterConnections(const TArray<struct FTechNodeLink>& ConnectionsIn, const TArray<class UTechnologyAsset*>& IgnoredParentTechnologies, const TArray<class UTechnologyAsset*>& IgnoredChildTechnologies) const
{
	static class UFunction* Func = nullptr;
	...
	Params::TechnologyTree_FilterConnections Parms{};

	Parms.ConnectionsIn = std::move(ConnectionsIn);
	Parms.IgnoredParentTechnologies = std::move(IgnoredParentTechnologies);
	Parms.IgnoredChildTechnologies = std::move(IgnoredChildTechnologies);
...
TArray<struct FTechNodeLink> UTechnologyTree::GetConnections() const
{
	static class UFunction* Func = nullptr;
	...
	Params::TechnologyTree_GetConnections Parms{};
...
// class UTechTreeWidget*                  TechTreeWidget_0                                       (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UTechTreeManager::AssignTechTree(class UTechnologyTree* TechTree, class UTechTreeWidget* TechTreeWidget_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::TechTreeManager_AssignTechTree Parms{};

	Parms.TechTree = TechTree;
	Parms.TechTreeWidget_0 = TechTreeWidget_0;
...
class UTechnologyTree* UTechTreeManager::GetAssignedTechTree()
{
	...
	Params::TechTreeManager_GetAssignedTechTree Parms{};
...
class UTTTechNode* UTechTreeManager::GetNodeFromTechAsset(class UTechnologyAsset* Technology)
{
	...
	Params::TechTreeManager_GetNodeFromTechAsset Parms{};
...
int32 UTechTreeManager::GetNumberTreesAssigned()
{
	...
	Params::TechTreeManager_GetNumberTreesAssigned Parms{};
...
class USaveGame* UTechTreeManager::GetSavegameTechObject()
{
	...
	Params::TechTreeManager_GetSavegameTechObject Parms{};
...
class UTechTreeWidget* UTechTreeManager::GetTechTreeWidget()
{
	...
	Params::TechTreeManager_GetTechTreeWidget Parms{};
...
void UTechTreeManager::HandleTechnologyStateChanged(class UTTTechNode* TechNode, bool IsUnlocked)
{
	...
	Params::TechTreeManager_HandleTechnologyStateChanged Parms{};
...
bool UTechTreeManager::HasUnlockedParents(class UTechnologyAsset* Technology)
{
	...
	Params::TechTreeManager_HasUnlockedParents Parms{};
...
bool UTechTreeManager::IsChildTechnology(class UTTTechNode* ParentNode, class UTechnologyAsset* ChildNodeTechnology)
{
	...
	Params::TechTreeManager_IsChildTechnology Parms{};
...
bool UTechTreeManager::IsTechnologyUnlocked(class UTechnologyAsset* Technology)
{
	...
	Params::TechTreeManager_IsTechnologyUnlocked Parms{};
...
void UTechTreeManager::LoadTechFromObject(class USaveGame* SaveGameObject)
{
	...
	Params::TechTreeManager_LoadTechFromObject Parms{};
...
void UTechTreeManager::LoadTechStateFromSlot(const class FString& SlotName, const int32 UserIndex)
{
	static class UFunction* Func = nullptr;
	...
	Params::TechTreeManager_LoadTechStateFromSlot Parms{};
...
void UTechTreeManager::LockTechnology(class UTechnologyAsset* Technology)
{
	...
	Params::TechTreeManager_LockTechnology Parms{};
...
void UTechTreeManager::SaveTechStateFromSlot(const class FString& SlotName, const int32 UserIndex)
{
	static class UFunction* Func = nullptr;
	...
	Params::TechTreeManager_SaveTechStateFromSlot Parms{};
...
void UTechTreeManager::SaveTechToObject(class USaveGame* SaveGameObject)
{
	...
	Params::TechTreeManager_SaveTechToObject Parms{};
...
void UTechTreeManager::SelectTechTree(class UTechnologyTree* TechTree)
{
	...
	Params::TechTreeManager_SelectTechTree Parms{};
...
void UTechTreeManager::UnlockTechnology(class UTechnologyAsset* Technology)
{
	...
	Params::TechTreeManager_UnlockTechnology Parms{};
...
TArray<class UTechNodeArrowWidget*> UTechTreeWidget::GetArrowWidgets()
{
	...
	Params::TechTreeWidget_GetArrowWidgets Parms{};
...
class UTechNodeWidget* UTechTreeWidget::GetTechNode(class UTechnologyAsset* TechnologyAsset)
{
	...
	Params::TechTreeWidget_GetTechNode Parms{};
...
TArray<class UTechNodeWidget*> UTechTreeWidget::GetTechNodeWidgets()
{
	...
	Params::TechTreeWidget_GetTechNodeWidgets Parms{};
...
void UTechTreeWidget::UpdateConnections(const TArray<struct FTechNodeLink>& Connections)
{
	static class UFunction* Func = nullptr;
	...
	Params::TechTreeWidget_UpdateConnections Parms{};
