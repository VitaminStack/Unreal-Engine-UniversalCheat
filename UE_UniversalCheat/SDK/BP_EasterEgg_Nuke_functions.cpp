...
#include "BP_EasterEgg_Nuke_classes.hpp"
#include "BP_EasterEgg_Nuke_parameters.hpp"
...
void ABP_EasterEgg_Nuke_C::Damage_Object(double Damage, class AActor* Damage_Causer, class AController* Event_Instigator)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_EasterEgg_Nuke_C", "Damage_Object");

	Params::BP_EasterEgg_Nuke_C_Damage_Object Parms{};
