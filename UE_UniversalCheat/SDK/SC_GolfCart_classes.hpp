...
// WidgetBlueprintGeneratedClass SC_GolfCart.SC_GolfCart_C
// 0x0010 (0x02D0 - 0x02C0)
class USC_GolfCart_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_SC_GolfCart(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"SC_GolfCart_C">();
	}
	static class USC_GolfCart_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<USC_GolfCart_C>();
	}
};
static_assert(alignof(USC_GolfCart_C) == 0x000008, "Wrong alignment on USC_GolfCart_C");
static_assert(sizeof(USC_GolfCart_C) == 0x0002D0, "Wrong size on USC_GolfCart_C");
static_assert(offsetof(USC_GolfCart_C, UberGraphFrame) == 0x0002C0, "Member 'USC_GolfCart_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USC_GolfCart_C, JSIContainer_1) == 0x0002C8, "Member 'USC_GolfCart_C::JSIContainer_1' has a wrong offset!");
