...
class UAnimNotify_MeleeHitDetect_Power_C final : public UAnimNotifyState
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AnimNotify_MeleeHitDetect_Power_C">();
	}
	static class UAnimNotify_MeleeHitDetect_Power_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAnimNotify_MeleeHitDetect_Power_C>();
	}
};
static_assert(alignof(UAnimNotify_MeleeHitDetect_Power_C) == 0x000008, "Wrong alignment on UAnimNotify_MeleeHitDetect_Power_C");
static_assert(sizeof(UAnimNotify_MeleeHitDetect_Power_C) == 0x000030, "Wrong size on UAnimNotify_MeleeHitDetect_Power_C");
