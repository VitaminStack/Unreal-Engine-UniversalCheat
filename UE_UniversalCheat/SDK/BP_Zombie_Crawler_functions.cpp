...
#include "BP_Zombie_Crawler_classes.hpp"
#include "BP_Zombie_Crawler_parameters.hpp"
...
void ABP_Zombie_Crawler_C::ExecuteUbergraph_BP_Zombie_Crawler(int32 EntryPoint)
{
	...
	Params::BP_Zombie_Crawler_C_ExecuteUbergraph_BP_Zombie_Crawler Parms{};
...
void ABP_Zombie_Crawler_C::GetMarker(class UTexture2D** Texture, struct FLinearColor* Color, double* MarkerOffset)
{
	...
	Params::BP_Zombie_Crawler_C_GetMarker Parms{};
