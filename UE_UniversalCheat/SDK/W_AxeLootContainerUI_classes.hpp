...
// WidgetBlueprintGeneratedClass W_AxeLootContainerUI.W_AxeLootContainerUI_C
// 0x0030 (0x02F0 - 0x02C0)
class UW_AxeLootContainerUI_C final : public UUserWidget
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"W_AxeLootContainerUI_C">();
	}
	static class UW_AxeLootContainerUI_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UW_AxeLootContainerUI_C>();
	}
};
static_assert(alignof(UW_AxeLootContainerUI_C) == 0x000008, "Wrong alignment on UW_AxeLootContainerUI_C");
static_assert(sizeof(UW_AxeLootContainerUI_C) == 0x0002F0, "Wrong size on UW_AxeLootContainerUI_C");
static_assert(offsetof(UW_AxeLootContainerUI_C, UberGraphFrame) == 0x0002C0, "Member 'UW_AxeLootContainerUI_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UW_AxeLootContainerUI_C, Button_66) == 0x0002C8, "Member 'UW_AxeLootContainerUI_C::Button_66' has a wrong offset!");
static_assert(offsetof(UW_AxeLootContainerUI_C, LootAllText) == 0x0002D0, "Member 'UW_AxeLootContainerUI_C::LootAllText' has a wrong offset!");
static_assert(offsetof(UW_AxeLootContainerUI_C, MainContainer) == 0x0002D8, "Member 'UW_AxeLootContainerUI_C::MainContainer' has a wrong offset!");
static_assert(offsetof(UW_AxeLootContainerUI_C, Array_Of_Items) == 0x0002E0, "Member 'UW_AxeLootContainerUI_C::Array_Of_Items' has a wrong offset!");
