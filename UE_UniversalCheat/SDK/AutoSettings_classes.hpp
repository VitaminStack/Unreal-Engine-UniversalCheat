...
{
public:
	class FName                                   CVarName;                                          // 0x02C0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class USettingValueMask>          ValueMask;                                         // 0x02C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoSave;                                         // 0x02D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoApply;                                        // 0x02D1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D2[0x6];                                      // 0x02D2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  SettingTags;                                       // 0x02D8(0x0020)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class FString                                 CurrentValue;                                      // 0x02F8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bHasUnappliedChange;                               // 0x0308(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bHasUnsavedChange;                                 // 0x0309(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bUpdatingSettingSelection;                         // 0x030A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAutoSettingWidget) == 0x000310, "Wrong size on UAutoSettingWidget");
static_assert(offsetof(UAutoSettingWidget, CVarName) == 0x0002C0, "Member 'UAutoSettingWidget::CVarName' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, ValueMask) == 0x0002C8, "Member 'UAutoSettingWidget::ValueMask' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bAutoSave) == 0x0002D0, "Member 'UAutoSettingWidget::bAutoSave' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bAutoApply) == 0x0002D1, "Member 'UAutoSettingWidget::bAutoApply' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, SettingTags) == 0x0002D8, "Member 'UAutoSettingWidget::SettingTags' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, CurrentValue) == 0x0002F8, "Member 'UAutoSettingWidget::CurrentValue' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bHasUnappliedChange) == 0x000308, "Member 'UAutoSettingWidget::bHasUnappliedChange' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bHasUnsavedChange) == 0x000309, "Member 'UAutoSettingWidget::bHasUnsavedChange' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bUpdatingSettingSelection) == 0x00030A, "Member 'UAutoSettingWidget::bUpdatingSettingSelection' has a wrong offset!");
...
static_assert(sizeof(UToggleSetting) == 0x000310, "Wrong size on UToggleSetting");
...
{
public:
	class UCheckBox*                              CheckBox;                                          // 0x0310(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCheckBoxSetting) == 0x000318, "Wrong size on UCheckBoxSetting");
static_assert(offsetof(UCheckBoxSetting, CheckBox) == 0x000310, "Member 'UCheckBoxSetting::CheckBox' has a wrong offset!");
...
{
public:
	TArray<struct FSettingOption>                 Options;                                           // 0x0310(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TSubclassOf<class USettingOptionFactory>      OptionFactory;                                     // 0x0320(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUpdatingSettingOptions;                           // 0x0328(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USelectSetting) == 0x000330, "Wrong size on USelectSetting");
static_assert(offsetof(USelectSetting, Options) == 0x000310, "Member 'USelectSetting::Options' has a wrong offset!");
static_assert(offsetof(USelectSetting, OptionFactory) == 0x000320, "Member 'USelectSetting::OptionFactory' has a wrong offset!");
static_assert(offsetof(USelectSetting, bUpdatingSettingOptions) == 0x000328, "Member 'USelectSetting::bUpdatingSettingOptions' has a wrong offset!");
...
{
public:
	class UComboBoxString*                        ComboBox;                                          // 0x0330(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UComboBoxSetting) == 0x000338, "Wrong size on UComboBoxSetting");
static_assert(offsetof(UComboBoxSetting, ComboBox) == 0x000330, "Member 'UComboBoxSetting::ComboBox' has a wrong offset!");
...
{
public:
	float                                         LeftValue;                                         // 0x0310(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RightValue;                                        // 0x0314(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USliderSetting) == 0x000318, "Wrong size on USliderSetting");
static_assert(offsetof(USliderSetting, LeftValue) == 0x000310, "Member 'USliderSetting::LeftValue' has a wrong offset!");
static_assert(offsetof(USliderSetting, RightValue) == 0x000314, "Member 'USliderSetting::RightValue' has a wrong offset!");
...
{
public:
	class USlider*                                Slider;                                            // 0x0318(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bMouseCaptureInProgress;                           // 0x0320(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNativeSliderSetting) == 0x000328, "Wrong size on UNativeSliderSetting");
static_assert(offsetof(UNativeSliderSetting, Slider) == 0x000318, "Member 'UNativeSliderSetting::Slider' has a wrong offset!");
static_assert(offsetof(UNativeSliderSetting, bMouseCaptureInProgress) == 0x000320, "Member 'UNativeSliderSetting::bMouseCaptureInProgress' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(const class FString& Value)> OnSelected;                                        // 0x02C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class FText                                   Label;                                             // 0x02D0(0x0018)(BlueprintVisible, BlueprintReadOnly, Protected, ExposeOnSpawn, NativeAccessSpecifierProtected)
	class FString                                 Value;                                             // 0x02E8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          Selected;                                          // 0x02F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(URadioButton) == 0x000300, "Wrong size on URadioButton");
static_assert(offsetof(URadioButton, OnSelected) == 0x0002C0, "Member 'URadioButton::OnSelected' has a wrong offset!");
static_assert(offsetof(URadioButton, Label) == 0x0002D0, "Member 'URadioButton::Label' has a wrong offset!");
static_assert(offsetof(URadioButton, Value) == 0x0002E8, "Member 'URadioButton::Value' has a wrong offset!");
static_assert(offsetof(URadioButton, Selected) == 0x0002F8, "Member 'URadioButton::Selected' has a wrong offset!");
...
{
public:
	TArray<struct FSettingOption>                 Options;                                           // 0x02C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TSubclassOf<class URadioButton>               RadioButtonClass;                                  // 0x02D0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoClear, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class FString& Value)> SelectionChangedEvent;                             // 0x02D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UPanelWidget*                           ButtonContainer;                                   // 0x02E8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class URadioButton*>                   RadioButtons;                                      // 0x02F0(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(URadioSelect) == 0x000300, "Wrong size on URadioSelect");
static_assert(offsetof(URadioSelect, Options) == 0x0002C0, "Member 'URadioSelect::Options' has a wrong offset!");
static_assert(offsetof(URadioSelect, RadioButtonClass) == 0x0002D0, "Member 'URadioSelect::RadioButtonClass' has a wrong offset!");
static_assert(offsetof(URadioSelect, SelectionChangedEvent) == 0x0002D8, "Member 'URadioSelect::SelectionChangedEvent' has a wrong offset!");
static_assert(offsetof(URadioSelect, ButtonContainer) == 0x0002E8, "Member 'URadioSelect::ButtonContainer' has a wrong offset!");
static_assert(offsetof(URadioSelect, RadioButtons) == 0x0002F0, "Member 'URadioSelect::RadioButtons' has a wrong offset!");
...
{
public:
	TSubclassOf<class URadioButton>               RadioButtonClass;                                  // 0x0330(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoClear, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class URadioSelect*                           RadioSelect;                                       // 0x0338(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URadioSelectSetting) == 0x000340, "Wrong size on URadioSelectSetting");
static_assert(offsetof(URadioSelectSetting, RadioButtonClass) == 0x000330, "Member 'URadioSelectSetting::RadioButtonClass' has a wrong offset!");
static_assert(offsetof(URadioSelectSetting, RadioSelect) == 0x000338, "Member 'URadioSelectSetting::RadioSelect' has a wrong offset!");
...
class USpinner final : public UUserWidget
{
public:
	TArray<struct FSettingOption>                 Options;                                           // 0x02C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bAllowWrapping;                                    // 0x02D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USpinner) == 0x0002F0, "Wrong size on USpinner");
static_assert(offsetof(USpinner, Options) == 0x0002C0, "Member 'USpinner::Options' has a wrong offset!");
static_assert(offsetof(USpinner, bAllowWrapping) == 0x0002D0, "Member 'USpinner::bAllowWrapping' has a wrong offset!");
static_assert(offsetof(USpinner, SelectionChangedEvent) == 0x0002D8, "Member 'USpinner::SelectionChangedEvent' has a wrong offset!");

// Class AutoSettings.SpinnerSetting
// 0x0008 (0x0338 - 0x0330)
class USpinnerSetting final : public USelectSetting
{
public:
	class USpinner*                               Spinner;                                           // 0x0330(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USpinnerSetting) == 0x000338, "Wrong size on USpinnerSetting");
static_assert(offsetof(USpinnerSetting, Spinner) == 0x000330, "Member 'USpinnerSetting::Spinner' has a wrong offset!");
