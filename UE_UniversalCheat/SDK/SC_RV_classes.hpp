...
class USC_RV_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_SC_RV(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"SC_RV_C">();
	}
	static class USC_RV_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<USC_RV_C>();
	}
};
static_assert(alignof(USC_RV_C) == 0x000008, "Wrong alignment on USC_RV_C");
static_assert(sizeof(USC_RV_C) == 0x0002D0, "Wrong size on USC_RV_C");
static_assert(offsetof(USC_RV_C, UberGraphFrame) == 0x0002C0, "Member 'USC_RV_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USC_RV_C, JSIContainer_1) == 0x0002C8, "Member 'USC_RV_C::JSIContainer_1' has a wrong offset!");
