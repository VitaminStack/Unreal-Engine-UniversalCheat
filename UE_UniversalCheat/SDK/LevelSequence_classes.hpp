...
static_assert(sizeof(ALevelSequenceActor) == 0x000338, "Wrong size on ALevelSequenceActor");
...
static_assert(offsetof(ALevelSequenceActor, WorldPartitionResolveData) == 0x000318, "Member 'ALevelSequenceActor::WorldPartitionResolveData' has a wrong offset!");
...
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x0004C8, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
...
static_assert(sizeof(ALevelSequenceMediaController) == 0x0002C0, "Wrong size on ALevelSequenceMediaController");
static_assert(offsetof(ALevelSequenceMediaController, Sequence) == 0x0002A0, "Member 'ALevelSequenceMediaController::Sequence' has a wrong offset!");
static_assert(offsetof(ALevelSequenceMediaController, MediaComponent) == 0x0002A8, "Member 'ALevelSequenceMediaController::MediaComponent' has a wrong offset!");
static_assert(offsetof(ALevelSequenceMediaController, ServerStartTimeSeconds) == 0x0002B0, "Member 'ALevelSequenceMediaController::ServerStartTimeSeconds' has a wrong offset!");
