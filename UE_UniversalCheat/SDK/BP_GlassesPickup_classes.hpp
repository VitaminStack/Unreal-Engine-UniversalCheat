...
// BlueprintGeneratedClass BP_GlassesPickup.BP_GlassesPickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_GlassesPickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_GlassesPickup_C;                 // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_GlassesPickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_GlassesPickup_C">();
	}
	static class ABP_GlassesPickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_GlassesPickup_C>();
	}
};
static_assert(alignof(ABP_GlassesPickup_C) == 0x000008, "Wrong alignment on ABP_GlassesPickup_C");
static_assert(sizeof(ABP_GlassesPickup_C) == 0x000318, "Wrong size on ABP_GlassesPickup_C");
static_assert(offsetof(ABP_GlassesPickup_C, UberGraphFrame_BP_GlassesPickup_C) == 0x000310, "Member 'ABP_GlassesPickup_C::UberGraphFrame_BP_GlassesPickup_C' has a wrong offset!");
