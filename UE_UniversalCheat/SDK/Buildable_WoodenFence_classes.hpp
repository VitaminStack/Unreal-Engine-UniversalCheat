...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Buildable_WoodenFence_C;            // 0x0430(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(ABuildable_WoodenFence_C) == 0x000440, "Wrong size on ABuildable_WoodenFence_C");
static_assert(offsetof(ABuildable_WoodenFence_C, UberGraphFrame_Buildable_WoodenFence_C) == 0x000430, "Member 'ABuildable_WoodenFence_C::UberGraphFrame_Buildable_WoodenFence_C' has a wrong offset!");
static_assert(offsetof(ABuildable_WoodenFence_C, Sphere) == 0x000438, "Member 'ABuildable_WoodenFence_C::Sphere' has a wrong offset!");
