...
class UAnimNotify_ZombieAttackRightArm_C final : public UAnimNotifyState
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"AnimNotify_ZombieAttackRightArm_C">();
	}
	static class UAnimNotify_ZombieAttackRightArm_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAnimNotify_ZombieAttackRightArm_C>();
	}
};
static_assert(alignof(UAnimNotify_ZombieAttackRightArm_C) == 0x000008, "Wrong alignment on UAnimNotify_ZombieAttackRightArm_C");
static_assert(sizeof(UAnimNotify_ZombieAttackRightArm_C) == 0x000030, "Wrong size on UAnimNotify_ZombieAttackRightArm_C");
