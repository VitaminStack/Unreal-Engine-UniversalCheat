...
// WidgetBlueprintGeneratedClass ClothingCupboardContainer_Widget.ClothingCupboardContainer_Widget_C
// 0x0010 (0x02D0 - 0x02C0)
class UClothingCupboardContainer_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_ClothingCupboardContainer_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"ClothingCupboardContainer_Widget_C">();
	}
	static class UClothingCupboardContainer_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UClothingCupboardContainer_Widget_C>();
	}
};
static_assert(alignof(UClothingCupboardContainer_Widget_C) == 0x000008, "Wrong alignment on UClothingCupboardContainer_Widget_C");
static_assert(sizeof(UClothingCupboardContainer_Widget_C) == 0x0002D0, "Wrong size on UClothingCupboardContainer_Widget_C");
static_assert(offsetof(UClothingCupboardContainer_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UClothingCupboardContainer_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UClothingCupboardContainer_Widget_C, MainContainer) == 0x0002C8, "Member 'UClothingCupboardContainer_Widget_C::MainContainer' has a wrong offset!");
