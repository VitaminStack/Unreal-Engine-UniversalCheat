...
// WidgetBlueprintGeneratedClass GunLockerContainer_Widget.GunLockerContainer_Widget_C
// 0x0010 (0x02D0 - 0x02C0)
class UGunLockerContainer_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_GunLockerContainer_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GunLockerContainer_Widget_C">();
	}
	static class UGunLockerContainer_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGunLockerContainer_Widget_C>();
	}
};
static_assert(alignof(UGunLockerContainer_Widget_C) == 0x000008, "Wrong alignment on UGunLockerContainer_Widget_C");
static_assert(sizeof(UGunLockerContainer_Widget_C) == 0x0002D0, "Wrong size on UGunLockerContainer_Widget_C");
static_assert(offsetof(UGunLockerContainer_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UGunLockerContainer_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGunLockerContainer_Widget_C, MainContainer) == 0x0002C8, "Member 'UGunLockerContainer_Widget_C::MainContainer' has a wrong offset!");
