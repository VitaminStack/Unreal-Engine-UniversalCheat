...
class USC_ModifedUtilityPickupTruck_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_SC_ModifedUtilityPickupTruck(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"SC_ModifedUtilityPickupTruck_C">();
	}
	static class USC_ModifedUtilityPickupTruck_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<USC_ModifedUtilityPickupTruck_C>();
	}
};
static_assert(alignof(USC_ModifedUtilityPickupTruck_C) == 0x000008, "Wrong alignment on USC_ModifedUtilityPickupTruck_C");
static_assert(sizeof(USC_ModifedUtilityPickupTruck_C) == 0x0002D0, "Wrong size on USC_ModifedUtilityPickupTruck_C");
static_assert(offsetof(USC_ModifedUtilityPickupTruck_C, UberGraphFrame) == 0x0002C0, "Member 'USC_ModifedUtilityPickupTruck_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USC_ModifedUtilityPickupTruck_C, JSIContainer_1) == 0x0002C8, "Member 'USC_ModifedUtilityPickupTruck_C::JSIContainer_1' has a wrong offset!");
