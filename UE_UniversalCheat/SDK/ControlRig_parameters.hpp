...
static_assert(offsetof(ControlRig_CreateTransformableControlHandle, Outer_0) == 0x000000, "Member 'ControlRig_CreateTransformableControlHandle::Outer_0' has a wrong offset!");
