...
// WidgetBlueprintGeneratedClass W_TrashBinUI.W_TrashBinUI_C
// 0x0038 (0x02F8 - 0x02C0)
class UW_TrashBinUI_C final : public UUserWidget
{
public:
	...
	class UJSIContainer_C*                        JSIContainer_1;                                    // 0x02E0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"W_TrashBinUI_C">();
	}
	static class UW_TrashBinUI_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UW_TrashBinUI_C>();
	}
};
static_assert(alignof(UW_TrashBinUI_C) == 0x000008, "Wrong alignment on UW_TrashBinUI_C");
static_assert(sizeof(UW_TrashBinUI_C) == 0x0002F8, "Wrong size on UW_TrashBinUI_C");
static_assert(offsetof(UW_TrashBinUI_C, UberGraphFrame) == 0x0002C0, "Member 'UW_TrashBinUI_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UW_TrashBinUI_C, BackText) == 0x0002C8, "Member 'UW_TrashBinUI_C::BackText' has a wrong offset!");
static_assert(offsetof(UW_TrashBinUI_C, EquipmentSlotTitle) == 0x0002D0, "Member 'UW_TrashBinUI_C::EquipmentSlotTitle' has a wrong offset!");
static_assert(offsetof(UW_TrashBinUI_C, ExitButton) == 0x0002D8, "Member 'UW_TrashBinUI_C::ExitButton' has a wrong offset!");
static_assert(offsetof(UW_TrashBinUI_C, JSIContainer_1) == 0x0002E0, "Member 'UW_TrashBinUI_C::JSIContainer_1' has a wrong offset!");
static_assert(offsetof(UW_TrashBinUI_C, All_Items) == 0x0002E8, "Member 'UW_TrashBinUI_C::All_Items' has a wrong offset!");
