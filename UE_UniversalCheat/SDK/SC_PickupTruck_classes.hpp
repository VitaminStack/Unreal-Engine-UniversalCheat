...
// WidgetBlueprintGeneratedClass SC_PickupTruck.SC_PickupTruck_C
// 0x0010 (0x02D0 - 0x02C0)
class USC_PickupTruck_C final : public UUserWidget
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"SC_PickupTruck_C">();
	}
	static class USC_PickupTruck_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<USC_PickupTruck_C>();
	}
};
static_assert(alignof(USC_PickupTruck_C) == 0x000008, "Wrong alignment on USC_PickupTruck_C");
static_assert(sizeof(USC_PickupTruck_C) == 0x0002D0, "Wrong size on USC_PickupTruck_C");
static_assert(offsetof(USC_PickupTruck_C, UberGraphFrame) == 0x0002C0, "Member 'USC_PickupTruck_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USC_PickupTruck_C, JSIContainer_1) == 0x0002C8, "Member 'USC_PickupTruck_C::JSIContainer_1' has a wrong offset!");
