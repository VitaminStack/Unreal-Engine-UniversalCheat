...
// WidgetBlueprintGeneratedClass MoneySafe_Widget.MoneySafe_Widget_C
// 0x0010 (0x02D0 - 0x02C0)
class UMoneySafe_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_MoneySafe_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"MoneySafe_Widget_C">();
	}
	static class UMoneySafe_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMoneySafe_Widget_C>();
	}
};
static_assert(alignof(UMoneySafe_Widget_C) == 0x000008, "Wrong alignment on UMoneySafe_Widget_C");
static_assert(sizeof(UMoneySafe_Widget_C) == 0x0002D0, "Wrong size on UMoneySafe_Widget_C");
static_assert(offsetof(UMoneySafe_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UMoneySafe_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMoneySafe_Widget_C, MainContainer) == 0x0002C8, "Member 'UMoneySafe_Widget_C::MainContainer' has a wrong offset!");
