...
#include "WB_Effect_Circular_classes.hpp"
#include "WB_Effect_Circular_parameters.hpp"
...
void UWB_Effect_Circular_C::AddAttributes(class UImage* Image)
{
	...
	Params::WB_Effect_Circular_C_AddAttributes Parms{};
...
// Parameters:
// struct FS_Effects                       Effect_0                                               (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)

void UWB_Effect_Circular_C::AddEffect(const struct FS_Effects& Effect_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_AddEffect Parms{};
...
void UWB_Effect_Circular_C::Anim_Fade(bool FadeIn_0, double PlaybackSpeed)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_Anim_Fade Parms{};
...
void UWB_Effect_Circular_C::Anim_Highlight1(double PlaybackSpeed)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_Anim_Highlight1 Parms{};
...
void UWB_Effect_Circular_C::Anim_Highlight2(double PlaybackSpeed)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_Anim_Highlight2 Parms{};
...
void UWB_Effect_Circular_C::Anim_HighlightLoop(bool StartStop, double PlaybackSpeed)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_Anim_HighlightLoop Parms{};
...
void UWB_Effect_Circular_C::CreateParticle(int32 NumParticles)
{
	...
	Params::WB_Effect_Circular_C_CreateParticle Parms{};
...
void UWB_Effect_Circular_C::EventPreConstruct(bool IsDesignTime)
{
	...
	Params::WB_Effect_Circular_C_EventPreConstruct Parms{};
...
void UWB_Effect_Circular_C::ExecuteUbergraph_WB_Effect_Circular(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_ExecuteUbergraph_WB_Effect_Circular Parms{};
...
double UWB_Effect_Circular_C::FindMinSize(const struct FVector2D& Size_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_FindMinSize Parms{};
...
void UWB_Effect_Circular_C::GetAddRotationToParticles(bool* Add_Rotation_to_Particles)
{
	...
	Params::WB_Effect_Circular_C_GetAddRotationToParticles Parms{};
...
void UWB_Effect_Circular_C::GetDecayTime(double* Decay_Time)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_GetDecayTime Parms{};
...
void UWB_Effect_Circular_C::GetEffectAngle(double* Effect_Angle)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_GetEffectAngle Parms{};
...
void UWB_Effect_Circular_C::GetEffectColor(struct FLinearColor* Effect_Color)
{
	...
	Params::WB_Effect_Circular_C_GetEffectColor Parms{};
...
void UWB_Effect_Circular_C::GetEffectScale(struct FVector2D* EffectScale)
{
	...
	Params::WB_Effect_Circular_C_GetEffectScale Parms{};
...
void UWB_Effect_Circular_C::GetEffectShear(struct FVector2D* Effect_Shear)
{
	...
	Params::WB_Effect_Circular_C_GetEffectShear Parms{};
...
void UWB_Effect_Circular_C::GetEffectTexture(class UObject** Custom_Effect_Texture)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_GetEffectTexture Parms{};
...
void UWB_Effect_Circular_C::GetEffectTranslation(struct FVector2D* Transition)
{
	...
	Params::WB_Effect_Circular_C_GetEffectTranslation Parms{};
...
void UWB_Effect_Circular_C::GetEffectType(EEffectType* Effect_Texture_Type)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_GetEffectType Parms{};
...
void UWB_Effect_Circular_C::GetNumParticles(int32* NumParticles)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_GetNumParticles Parms{};
...
void UWB_Effect_Circular_C::GetParticleSpread(double* Particle_Spread)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_GetParticleSpread Parms{};
...
void UWB_Effect_Circular_C::GetPlaybackSpeed(double* Playback_Speed)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_GetPlaybackSpeed Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UProgressBarCircular_C*           ProgressBar                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UWB_Effect_Circular_C::GetProgressBar(class UProgressBarCircular_C* ProgressBar)
{
	...
	Params::WB_Effect_Circular_C_GetProgressBar Parms{};
...
void UWB_Effect_Circular_C::GetSoundEffect(class USoundBase** Sound_Effect)
{
	...
	Params::WB_Effect_Circular_C_GetSoundEffect Parms{};
...
void UWB_Effect_Circular_C::GetSoundVolume(double* Sound_Volume_Multiplier)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_GetSoundVolume Parms{};
...
void UWB_Effect_Circular_C::GetSpecificPercentValue(double* Specific_Percent_Value)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_GetSpecificPercentValue Parms{};
...
void UWB_Effect_Circular_C::GetTriggerMethod(ETriggerMethod* Trigger)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_GetTriggerMethod Parms{};
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// bool                                    Use_Stretched_Particle                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWB_Effect_Circular_C::GetUseParticleStretched(bool* Use_Stretched_Particle)
{
	...
	Params::WB_Effect_Circular_C_GetUseParticleStretched Parms{};
...
bool UWB_Effect_Circular_C::IsEffectTypeParticle()
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_IsEffectTypeParticle Parms{};
...
bool UWB_Effect_Circular_C::IsEffectTypeProgressChangeColor()
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_IsEffectTypeProgressChangeColor Parms{};
...
bool UWB_Effect_Circular_C::IsEffectTypeSoundEffect()
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_IsEffectTypeSoundEffect Parms{};
...
bool UWB_Effect_Circular_C::IsEffectTypeSoundEffectLooped()
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_IsEffectTypeSoundEffectLooped Parms{};
...
bool UWB_Effect_Circular_C::IsTriggeredAlways()
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_IsTriggeredAlways Parms{};
...
bool UWB_Effect_Circular_C::IsTriggeredAlwaysOnSpecificPercentValue()
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_IsTriggeredAlwaysOnSpecificPercentValue Parms{};
...
bool UWB_Effect_Circular_C::IsTriggerSpecificPercent()
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_IsTriggerSpecificPercent Parms{};
...
void UWB_Effect_Circular_C::RemoveParticleFromOverlay(class UOverlay* Overlay)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_RemoveParticleFromOverlay Parms{};
...
void UWB_Effect_Circular_C::SetSize(double Size_0, double Thickness_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_SetSize Parms{};
...
void UWB_Effect_Circular_C::SwitchEffectType(int32 Index_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_SwitchEffectType Parms{};
...
void UWB_Effect_Circular_C::SwitchPunctiform(int32 Index_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_SwitchPunctiform Parms{};
...
void UWB_Effect_Circular_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
{
	...
	Params::WB_Effect_Circular_C_Tick Parms{};
...
void UWB_Effect_Circular_C::UpdatePercent(double Percent)
{
	static class UFunction* Func = nullptr;
	...
	Params::WB_Effect_Circular_C_UpdatePercent Parms{};
