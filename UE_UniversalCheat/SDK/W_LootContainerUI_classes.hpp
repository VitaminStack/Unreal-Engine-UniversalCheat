...
// WidgetBlueprintGeneratedClass W_LootContainerUI.W_LootContainerUI_C
// 0x0030 (0x02F0 - 0x02C0)
class UW_LootContainerUI_C final : public UUserWidget
{
public:
...
public:
	void BndEvt__Container_Widget_Button_66_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature();
	void ExecuteUbergraph_W_LootContainerUI(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"W_LootContainerUI_C">();
	}
	static class UW_LootContainerUI_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UW_LootContainerUI_C>();
	}
};
static_assert(alignof(UW_LootContainerUI_C) == 0x000008, "Wrong alignment on UW_LootContainerUI_C");
static_assert(sizeof(UW_LootContainerUI_C) == 0x0002F0, "Wrong size on UW_LootContainerUI_C");
static_assert(offsetof(UW_LootContainerUI_C, UberGraphFrame) == 0x0002C0, "Member 'UW_LootContainerUI_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UW_LootContainerUI_C, Button_66) == 0x0002C8, "Member 'UW_LootContainerUI_C::Button_66' has a wrong offset!");
static_assert(offsetof(UW_LootContainerUI_C, LootAllText) == 0x0002D0, "Member 'UW_LootContainerUI_C::LootAllText' has a wrong offset!");
static_assert(offsetof(UW_LootContainerUI_C, MainContainer) == 0x0002D8, "Member 'UW_LootContainerUI_C::MainContainer' has a wrong offset!");
static_assert(offsetof(UW_LootContainerUI_C, Array_Of_Items) == 0x0002E0, "Member 'UW_LootContainerUI_C::Array_Of_Items' has a wrong offset!");
