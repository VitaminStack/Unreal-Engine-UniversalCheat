...
public:
	...
	static void DebugAIOptimizer(class UWorld* World, bool bDebug);
...
public:
	...
	TSubclassOf<class UUserWidget>                DebugWidgetClass;                                  // 0x0040(0x0008)(Edit, ZeroConstructor, Config, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class UUserWidget*                            DebugWidget;                                       // 0x00A0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAIOInvokerComponent) == 0x0000A8, "Wrong size on UAIOInvokerComponent");
static_assert(offsetof(UAIOInvokerComponent, DebugWidget) == 0x0000A0, "Member 'UAIOInvokerComponent::DebugWidget' has a wrong offset!");
...
public:
	...
	class UUserWidget*                            DebugWidgetObj;                                    // 0x00C8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FAIOSubjectHandle                      Handle;                                            // 0x00C8(0x0004)(BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_CC[0x4];                                       // 0x00CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(bool bIsBeyondLastLayer, int32 LayerIndex, bool bIsSeen)> OnOptimizationUpdate;                              // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UAIOData_Base* Data)> OnPreDespawn;                                      // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UAIOData_Base* Data)> OnPostSpawned;                                     // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class AActor*                                 Spawner;                                           // 0x0100(0x0008)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bCanBeUpdatedBySubsystem : 1;                      // 0x0108(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowSubsystemToAutoDespawn : 1;                  // 0x0108(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_109[0x3];                                      // 0x0109(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OverrideSubsystemDespawnRadius;                    // 0x010C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Priority;                                          // 0x0110(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_111[0x7];                                      // 0x0111(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UAIOData_Base>              DataClass;                                         // 0x0118(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FAIOptimizationLayer>           OptimizationLayers;                                // 0x0120(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         bShouldCalculateIsSeen : 1;                        // 0x0130(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UAIOSubjectComponent) == 0x000140, "Wrong size on UAIOSubjectComponent");
static_assert(offsetof(UAIOSubjectComponent, Handle) == 0x0000C8, "Member 'UAIOSubjectComponent::Handle' has a wrong offset!");
static_assert(offsetof(UAIOSubjectComponent, OnOptimizationUpdate) == 0x0000D0, "Member 'UAIOSubjectComponent::OnOptimizationUpdate' has a wrong offset!");
static_assert(offsetof(UAIOSubjectComponent, OnPreDespawn) == 0x0000E0, "Member 'UAIOSubjectComponent::OnPreDespawn' has a wrong offset!");
static_assert(offsetof(UAIOSubjectComponent, OnPostSpawned) == 0x0000F0, "Member 'UAIOSubjectComponent::OnPostSpawned' has a wrong offset!");
static_assert(offsetof(UAIOSubjectComponent, Spawner) == 0x000100, "Member 'UAIOSubjectComponent::Spawner' has a wrong offset!");
static_assert(offsetof(UAIOSubjectComponent, OverrideSubsystemDespawnRadius) == 0x00010C, "Member 'UAIOSubjectComponent::OverrideSubsystemDespawnRadius' has a wrong offset!");
static_assert(offsetof(UAIOSubjectComponent, Priority) == 0x000110, "Member 'UAIOSubjectComponent::Priority' has a wrong offset!");
static_assert(offsetof(UAIOSubjectComponent, DataClass) == 0x000118, "Member 'UAIOSubjectComponent::DataClass' has a wrong offset!");
static_assert(offsetof(UAIOSubjectComponent, OptimizationLayers) == 0x000120, "Member 'UAIOSubjectComponent::OptimizationLayers' has a wrong offset!");

// Class AIOptimizer.SpawnerInterface
// 0x0000 (0x0028 - 0x0028)
class ISpawnerInterface final : public IInterface
{
public:
...
static_assert(alignof(ISpawnerInterface) == 0x000008, "Wrong alignment on ISpawnerInterface");
static_assert(sizeof(ISpawnerInterface) == 0x000028, "Wrong size on ISpawnerInterface");
