...
// WidgetBlueprintGeneratedClass SC_Buggy.SC_Buggy_C
// 0x0010 (0x02D0 - 0x02C0)
class USC_Buggy_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_SC_Buggy(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"SC_Buggy_C">();
	}
	static class USC_Buggy_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<USC_Buggy_C>();
	}
};
static_assert(alignof(USC_Buggy_C) == 0x000008, "Wrong alignment on USC_Buggy_C");
static_assert(sizeof(USC_Buggy_C) == 0x0002D0, "Wrong size on USC_Buggy_C");
static_assert(offsetof(USC_Buggy_C, UberGraphFrame) == 0x0002C0, "Member 'USC_Buggy_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USC_Buggy_C, JSIContainer_1) == 0x0002C8, "Member 'USC_Buggy_C::JSIContainer_1' has a wrong offset!");
