...
public:
	...
	uint8                                         Pad_9F[0x99];                                      // 0x009F(0x0099)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_13C[0x74];                                     // 0x013C(0x0074)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B8[0x58];                                     // 0x01B8(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_520[0xD0];                                     // 0x0520(0x00D0)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreInitializeDelegate;                           // 0x0578(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostInitializeDelegate;                          // 0x0588(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreConstructionDelegate;                         // 0x0598(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostConstructionDelegate;                        // 0x05A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreForwardsSolveDelegate;                        // 0x05B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostForwardsSolveDelegate;                       // 0x05C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_618[0xB8];                                     // 0x0618(0x00B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CC[0x10];                                     // 0x02CC(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_621[0x2F];                                     // 0x0621(0x002F)(Fixing Struct Size After Last Property [ Dumper-7 ])
