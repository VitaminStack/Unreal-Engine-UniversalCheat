...
// WidgetBlueprintGeneratedClass StorageContainer2_Widget.StorageContainer2_Widget_C
// 0x0010 (0x02D0 - 0x02C0)
class UStorageContainer2_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_StorageContainer2_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"StorageContainer2_Widget_C">();
	}
	static class UStorageContainer2_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UStorageContainer2_Widget_C>();
	}
};
static_assert(alignof(UStorageContainer2_Widget_C) == 0x000008, "Wrong alignment on UStorageContainer2_Widget_C");
static_assert(sizeof(UStorageContainer2_Widget_C) == 0x0002D0, "Wrong size on UStorageContainer2_Widget_C");
static_assert(offsetof(UStorageContainer2_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UStorageContainer2_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UStorageContainer2_Widget_C, MainContainer) == 0x0002C8, "Member 'UStorageContainer2_Widget_C::MainContainer' has a wrong offset!");
