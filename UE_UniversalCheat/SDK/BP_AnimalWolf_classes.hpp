...
// BlueprintGeneratedClass BP_AnimalWolf.BP_AnimalWolf_C
// 0x00E0 (0x0780 - 0x06A0)
class ABP_AnimalWolf_C final : public ABP_Animal_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_AnimalWolf_C;                    // 0x06A0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UAudioComponent*                        Wolf_Noises;                                       // 0x06A8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          BloodSplatterEnabled;                              // 0x0708(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class FName>                           Sockets;                                           // 0x0718(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                          XpPopUpEnabled_;                                   // 0x0728(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_729[0x7];                                      // 0x0729(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        Health;                                            // 0x0730(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAnimMontage*                           HitAnimation;                                      // 0x0738(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                             HitSound;                                          // 0x0740(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          IsDead_;                                           // 0x0748(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CanAddMarker_;                                     // 0x0749(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_74A[0x6];                                      // 0x074A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UWidgetComponent*                       Marker;                                            // 0x0750(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                           MarkerTimer;                                       // 0x0758(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          Is_Burning_;                                       // 0x0760(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_761[0x7];                                      // 0x0761(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UParticleSystemComponent*               BurningEffect;                                     // 0x0768(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                           BurningTimer;                                      // 0x0770(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          Looted;                                            // 0x0778(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void ExecuteUbergraph_BP_AnimalWolf(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_AnimalWolf_C">();
	}
	static class ABP_AnimalWolf_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_AnimalWolf_C>();
	}
};
static_assert(alignof(ABP_AnimalWolf_C) == 0x000010, "Wrong alignment on ABP_AnimalWolf_C");
static_assert(sizeof(ABP_AnimalWolf_C) == 0x000780, "Wrong size on ABP_AnimalWolf_C");
static_assert(offsetof(ABP_AnimalWolf_C, UberGraphFrame_BP_AnimalWolf_C) == 0x0006A0, "Member 'ABP_AnimalWolf_C::UberGraphFrame_BP_AnimalWolf_C' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, Wolf_Noises) == 0x0006A8, "Member 'ABP_AnimalWolf_C::Wolf_Noises' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, BP_JigMultiplayer) == 0x0006B0, "Member 'ABP_AnimalWolf_C::BP_JigMultiplayer' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, NavigationInvoker) == 0x0006B8, "Member 'ABP_AnimalWolf_C::NavigationInvoker' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, CCCollisionHandler) == 0x0006C0, "Member 'ABP_AnimalWolf_C::CCCollisionHandler' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, AIOSubject) == 0x0006C8, "Member 'ABP_AnimalWolf_C::AIOSubject' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, DamageToDo) == 0x0006D0, "Member 'ABP_AnimalWolf_C::DamageToDo' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, Start_Attacking) == 0x0006D8, "Member 'ABP_AnimalWolf_C::Start_Attacking' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, AttackMontage) == 0x0006E0, "Member 'ABP_AnimalWolf_C::AttackMontage' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, InteractingActorLoc) == 0x0006F0, "Member 'ABP_AnimalWolf_C::InteractingActorLoc' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, BloodSplatterEnabled) == 0x000708, "Member 'ABP_AnimalWolf_C::BloodSplatterEnabled' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, CurrentActor) == 0x000710, "Member 'ABP_AnimalWolf_C::CurrentActor' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, Sockets) == 0x000718, "Member 'ABP_AnimalWolf_C::Sockets' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, XpPopUpEnabled_) == 0x000728, "Member 'ABP_AnimalWolf_C::XpPopUpEnabled_' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, Health) == 0x000730, "Member 'ABP_AnimalWolf_C::Health' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, HitAnimation) == 0x000738, "Member 'ABP_AnimalWolf_C::HitAnimation' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, HitSound) == 0x000740, "Member 'ABP_AnimalWolf_C::HitSound' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, IsDead_) == 0x000748, "Member 'ABP_AnimalWolf_C::IsDead_' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, CanAddMarker_) == 0x000749, "Member 'ABP_AnimalWolf_C::CanAddMarker_' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, Marker) == 0x000750, "Member 'ABP_AnimalWolf_C::Marker' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, MarkerTimer) == 0x000758, "Member 'ABP_AnimalWolf_C::MarkerTimer' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, Is_Burning_) == 0x000760, "Member 'ABP_AnimalWolf_C::Is_Burning_' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, BurningEffect) == 0x000768, "Member 'ABP_AnimalWolf_C::BurningEffect' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, BurningTimer) == 0x000770, "Member 'ABP_AnimalWolf_C::BurningTimer' has a wrong offset!");
static_assert(offsetof(ABP_AnimalWolf_C, Looted) == 0x000778, "Member 'ABP_AnimalWolf_C::Looted' has a wrong offset!");
