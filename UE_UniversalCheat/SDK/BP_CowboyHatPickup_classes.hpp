...
// BlueprintGeneratedClass BP_CowboyHatPickup.BP_CowboyHatPickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_CowboyHatPickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_CowboyHatPickup_C;               // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_CowboyHatPickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_CowboyHatPickup_C">();
	}
	static class ABP_CowboyHatPickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_CowboyHatPickup_C>();
	}
};
static_assert(alignof(ABP_CowboyHatPickup_C) == 0x000008, "Wrong alignment on ABP_CowboyHatPickup_C");
static_assert(sizeof(ABP_CowboyHatPickup_C) == 0x000318, "Wrong size on ABP_CowboyHatPickup_C");
static_assert(offsetof(ABP_CowboyHatPickup_C, UberGraphFrame_BP_CowboyHatPickup_C) == 0x000310, "Member 'ABP_CowboyHatPickup_C::UberGraphFrame_BP_CowboyHatPickup_C' has a wrong offset!");
