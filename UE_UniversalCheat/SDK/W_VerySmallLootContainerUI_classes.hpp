...
// WidgetBlueprintGeneratedClass W_VerySmallLootContainerUI.W_VerySmallLootContainerUI_C
// 0x0030 (0x02F0 - 0x02C0)
class UW_VerySmallLootContainerUI_C final : public UUserWidget
{
public:
...
public:
	...
	void ExecuteUbergraph_W_VerySmallLootContainerUI(int32 EntryPoint);
	void BndEvt__VerySmallContainer_Widget_Button_66_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature();
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"W_VerySmallLootContainerUI_C">();
	}
	static class UW_VerySmallLootContainerUI_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UW_VerySmallLootContainerUI_C>();
	}
};
static_assert(alignof(UW_VerySmallLootContainerUI_C) == 0x000008, "Wrong alignment on UW_VerySmallLootContainerUI_C");
static_assert(sizeof(UW_VerySmallLootContainerUI_C) == 0x0002F0, "Wrong size on UW_VerySmallLootContainerUI_C");
static_assert(offsetof(UW_VerySmallLootContainerUI_C, UberGraphFrame) == 0x0002C0, "Member 'UW_VerySmallLootContainerUI_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UW_VerySmallLootContainerUI_C, Button_66) == 0x0002C8, "Member 'UW_VerySmallLootContainerUI_C::Button_66' has a wrong offset!");
static_assert(offsetof(UW_VerySmallLootContainerUI_C, LootAllText) == 0x0002D0, "Member 'UW_VerySmallLootContainerUI_C::LootAllText' has a wrong offset!");
static_assert(offsetof(UW_VerySmallLootContainerUI_C, MainContainer) == 0x0002D8, "Member 'UW_VerySmallLootContainerUI_C::MainContainer' has a wrong offset!");
static_assert(offsetof(UW_VerySmallLootContainerUI_C, Array_Of_Items) == 0x0002E0, "Member 'UW_VerySmallLootContainerUI_C::Array_Of_Items' has a wrong offset!");
