...
#include "BP_CookingStation_classes.hpp"
#include "BP_CookingStation_parameters.hpp"
...
void ABP_CookingStation_C::JigMP_OnItemConsumed(const struct FRepItemInfo& ConsumedItem, int32 Amount, int32 Remaining, const struct FRepItemInfo& InsideOf, class FName FromContainer, const class FString& CustomData, bool CallbackToPlayer_, bool* Result)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CookingStation_C", "JigMP_OnItemConsumed");

	Params::BP_CookingStation_C_JigMP_OnItemConsumed Parms{};
