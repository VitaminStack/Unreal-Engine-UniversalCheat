...
namespace Offsets
{
	constexpr int32 GObjects          = 0x06EEA6F0;
	constexpr int32 AppendString      = 0x00C886D0;
	constexpr int32 GNames            = 0x06E44340;
	constexpr int32 GWorld            = 0x070547B0;
	constexpr int32 ProcessEvent      = 0x00E42B00;
