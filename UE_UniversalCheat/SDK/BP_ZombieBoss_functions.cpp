...
#include "BP_ZombieBoss_parameters.hpp"
...
void ABP_ZombieBoss_C::Actor_Aim_Focus(class AActor* Instigator_0)
{
	...
	Params::BP_ZombieBoss_C_Actor_Aim_Focus Parms{};
...
void ABP_ZombieBoss_C::Actor_Attack_Target(class AActor** Attack_Target)
{
	...
	Params::BP_ZombieBoss_C_Actor_Attack_Target Parms{};
...
void ABP_ZombieBoss_C::AddMarker(class UWidgetComponent* Marker_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_AddMarker Parms{};
...
void ABP_ZombieBoss_C::AI_Alert(class AActor* Alert_Actor)
{
	...
	Params::BP_ZombieBoss_C_AI_Alert Parms{};
...
void ABP_ZombieBoss_C::AI_Animation_Switch(E_AIBehaviour Behaviour)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_AI_Animation_Switch Parms{};
...
void ABP_ZombieBoss_C::AI_Block(E_BlockType Block_Type, class AActor* Block_Attacker)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_AI_Block Parms{};
...
void ABP_ZombieBoss_C::AI_Camera_Activate(bool Activate)
{
	...
	Params::BP_ZombieBoss_C_AI_Camera_Activate Parms{};
...
void ABP_ZombieBoss_C::AI_Can_Interact_(bool* Can_Interact)
{
	...
	Params::BP_ZombieBoss_C_AI_Can_Interact_ Parms{};
...
void ABP_ZombieBoss_C::AIHealthBarInfo(bool* Visible_, class FString* Name_0, bool* Boss_)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_AIHealthBarInfo Parms{};
...
void ABP_ZombieBoss_C::Alert_Actor_Defenders(class AActor* Attacked, class AActor* Attacker)
{
	...
	Params::BP_ZombieBoss_C_Alert_Actor_Defenders Parms{};
...
void ABP_ZombieBoss_C::BndEvt__BP_MasterZombie_DamageComponent_K2Node_ComponentBoundEvent_1_Death__DelegateSignature(class AActor* DmgCauser, bool Headshot)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "BndEvt__BP_MasterZombie_DamageComponent_K2Node_ComponentBoundEvent_1_Death__DelegateSignature");

	Params::BP_ZombieBoss_C_BndEvt__BP_MasterZombie_DamageComponent_K2Node_ComponentBoundEvent_1_Death__DelegateSignature Parms{};
...
void ABP_ZombieBoss_C::BndEvt__BP_Zombie_Master_AIOSubject_K2Node_ComponentBoundEvent_2_OnOptimizationUpdate__DelegateSignature(bool bIsBeyondLastLayer, int32 LayerIndex, bool bIsSeen)
{
	...
	Params::BP_ZombieBoss_C_BndEvt__BP_Zombie_Master_AIOSubject_K2Node_ComponentBoundEvent_2_OnOptimizationUpdate__DelegateSignature Parms{};
...
void ABP_ZombieBoss_C::BndEvt__DamageTester_DamageComponent_K2Node_ComponentBoundEvent_0_StandardDamage__DelegateSignature(double Dmg, class AActor* DmgCauser)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "BndEvt__DamageTester_DamageComponent_K2Node_ComponentBoundEvent_0_StandardDamage__DelegateSignature");

	Params::BP_ZombieBoss_C_BndEvt__DamageTester_DamageComponent_K2Node_ComponentBoundEvent_0_StandardDamage__DelegateSignature Parms{};
...
void ABP_ZombieBoss_C::CanAddMarkerToAI_(bool* CanAdd_)
{
	...
	Params::BP_ZombieBoss_C_CanAddMarkerToAI_ Parms{};
...
void ABP_ZombieBoss_C::CanStompAI_(bool* Stomp_)
{
	...
	Params::BP_ZombieBoss_C_CanStompAI_ Parms{};
...
void ABP_ZombieBoss_C::Change_Speed(double Speed)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_Change_Speed Parms{};
...
void ABP_ZombieBoss_C::CheckDistanceFromActor()
{
	static class UFunction* Func = nullptr;
...
void ABP_ZombieBoss_C::Death(class AActor* Player)
{
	...
	Params::BP_ZombieBoss_C_Death Parms{};
...
void ABP_ZombieBoss_C::Event_DamageMultiplier(float NewValue)
{
	...
	Params::BP_ZombieBoss_C_Event_DamageMultiplier Parms{};
...
// Function BP_ZombieBoss.BP_ZombieBoss_C.Event_Despawn
// (BlueprintCallable, BlueprintEvent)

void ABP_ZombieBoss_C::Event_Despawn()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "Event_Despawn");

	UObject::ProcessEvent(Func, nullptr);
}


// Function BP_ZombieBoss.BP_ZombieBoss_C.Event_Fire
// (BlueprintCallable, BlueprintEvent)

void ABP_ZombieBoss_C::Event_Fire()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "Event_Fire");
...
void ABP_ZombieBoss_C::Event_HealthMultiplier(float NewValue)
{
	...
	Params::BP_ZombieBoss_C_Event_HealthMultiplier Parms{};
...
void ABP_ZombieBoss_C::Event_OnHit(const struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_Event_OnHit Parms{};
...
void ABP_ZombieBoss_C::Event_SpeedMultiplier(float NewValue)
{
	...
	Params::BP_ZombieBoss_C_Event_SpeedMultiplier Parms{};
...
void ABP_ZombieBoss_C::Event_XP(bool NewValue)
{
	...
	Params::BP_ZombieBoss_C_Event_XP Parms{};
...
void ABP_ZombieBoss_C::ExecuteUbergraph_BP_ZombieBoss(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_ExecuteUbergraph_BP_ZombieBoss Parms{};
...
void ABP_ZombieBoss_C::GetInteractOptions(TMap<struct FGameplayTag, class FText>* Options)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_GetInteractOptions Parms{};
...
void ABP_ZombieBoss_C::GetItemInfo(class UJigsawItem_DataAsset_C** Info, int32* Count, struct FS_RandomStatsConfig* RandomStatsConfig, TMap<class FString, class FString>* CustomData)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_GetItemInfo Parms{};
...
void ABP_ZombieBoss_C::GetJigMultiplayerComponent(class UActorComponent** JigComp)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_GetJigMultiplayerComponent Parms{};
...
void ABP_ZombieBoss_C::GetMainSceneComp(class USceneComponent** Comp)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "GetMainSceneComp");

	Params::BP_ZombieBoss_C_GetMainSceneComp Parms{};
...
void ABP_ZombieBoss_C::GetMarker(class UTexture2D** Texture, struct FLinearColor* Color, double* MarkerOffset)
{
	...
	Params::BP_ZombieBoss_C_GetMarker Parms{};
...
void ABP_ZombieBoss_C::GetMesh(class USkeletalMeshComponent** Mesh_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_GetMesh Parms{};
...
void ABP_ZombieBoss_C::GetMovementSpeeds(double* RoamingSpeed, double* AlertSpeed, double* AttackSpeed)
{
	...
	Params::BP_ZombieBoss_C_GetMovementSpeeds Parms{};
...
void ABP_ZombieBoss_C::HitByVehicle(double Speed, const struct FVector& Direction)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "HitByVehicle");

	Params::BP_ZombieBoss_C_HitByVehicle Parms{};
...
void ABP_ZombieBoss_C::IsAIBurning_(bool* IsBurning_)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "IsAIBurning?");

	Params::BP_ZombieBoss_C_IsAIBurning_ Parms{};
...
void ABP_ZombieBoss_C::JigCanInteract(bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigCanInteract Parms{};
...
void ABP_ZombieBoss_C::JigMP_GetLootWidget(class UWidget** Result, bool* Valid_)
{
	...
	Params::BP_ZombieBoss_C_JigMP_GetLootWidget Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnContainersSwap(class UJSIContainer_C* Container1, class UJSIContainer_C* Container2, bool* Result)
{
	...
	Params::BP_ZombieBoss_C_JigMP_OnContainersSwap Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnItemAdded(const struct FGuid& ItemUID, const struct FGuid& FromContainerUID, const struct FGuid& ToContainerUID, class UActorComponent* FromComponent, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigMP_OnItemAdded Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnItemConsumed(const struct FRepItemInfo& ConsumedItem, int32 Amount, int32 Remaining, const struct FRepItemInfo& InsideOf, class FName FromContainer, const class FString& CustomData, bool CallbackToPlayer_, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigMP_OnItemConsumed Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnItemDropped(const struct FGuid& ItemUID, const struct FGuid& FromContainerUID, class AActor* ActorRef, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigMP_OnItemDropped Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnItemMoved(const struct FGuid& ItemUID, const struct FGuid& FromContainerUID, const struct FGuid& ToContainerUID, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigMP_OnItemMoved Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnItemRemoved(const struct FGuid& ItemUID, const struct FGuid& FromContainerUID, const struct FGuid& ToContainerUID, class UActorComponent* ToComponent, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigMP_OnItemRemoved Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnMainContainerItemAdded(const struct FGuid& ToContainerUID, const struct FGuid& ItemUID, class FName ToContainerName, const struct FRepItemInfo& ItemInfo, class FName FromMain, bool* Result, class AActor** ActorRef)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigMP_OnMainContainerItemAdded Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnMainContainerItemRemoved(const struct FGuid& FromContainerUID, const struct FGuid& ItemUID, class FName ContainerName, const struct FRepItemInfo& ItemRemovedInfo, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigMP_OnMainContainerItemRemoved Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnPickupAdded(const struct FRepItemInfo& Info, const struct FGuid& ItemUID, const struct FGuid& ToContainerUID, class FName ToContainer, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigMP_OnPickupAdded Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnPickupEquipped(class AActor* ActorRef, class FName ToContainerName, const struct FGuid& UID, const struct FGuid& ToContainerUID, const struct FRepItemInfo& Info, bool* Result, class AActor** OverrideActor)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigMP_OnPickupEquipped Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnRequestDropItem(const struct FRepItemInfo& ItemInfo, class FName ContainerName, class AActor** ActorRef)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigMP_OnRequestDropItem Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnTwoContainersSwap(class FName FromContainer, class FName ToContainer, bool* Result)
{
	...
	Params::BP_ZombieBoss_C_JigMP_OnTwoContainersSwap Parms{};
...
void ABP_ZombieBoss_C::JigMP_OnUpdateChamberUID(const struct FGuid& NewUID, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_JigMP_OnUpdateChamberUID Parms{};
...
void ABP_ZombieBoss_C::JigSetCanInteract(bool CanInteract, bool EnablePhysics, bool* Result)
{
	...
	Params::BP_ZombieBoss_C_JigSetCanInteract Parms{};
...
void ABP_ZombieBoss_C::LeftArmTrace()
{
	static class UFunction* Func = nullptr;
...
void ABP_ZombieBoss_C::OnBeginInteract(class AActor* InteractingActor, const TMap<struct FGameplayTag, class FText>& Options)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_OnBeginInteract Parms{};
...
void ABP_ZombieBoss_C::OnExecuteInteract(class AActor* InteractingActor, const struct FGameplayTag& Option)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_OnExecuteInteract Parms{};
...
void ABP_ZombieBoss_C::OnExecuteInteractDialogue(class AActor* InteractingActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "OnExecuteInteractDialogue");

	Params::BP_ZombieBoss_C_OnExecuteInteractDialogue Parms{};
...
void ABP_ZombieBoss_C::OnRep_IsDead_()
{
	static class UFunction* Func = nullptr;
...
void ABP_ZombieBoss_C::OnRequestServerInteract(class AActor* Actor, const struct FGameplayTag& Option, const struct FS_JigPayload& Payload, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_OnRequestServerInteract Parms{};
...
void ABP_ZombieBoss_C::OnServerExecuteInteract(const struct FGameplayTag& Option, class AActor* ByActor, const struct FS_JigPayload& Payload)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_OnServerExecuteInteract Parms{};
...
void ABP_ZombieBoss_C::OnStopExecuteInteract(class AActor* InteractingActor)
{
	...
	Params::BP_ZombieBoss_C_OnStopExecuteInteract Parms{};
...
void ABP_ZombieBoss_C::Outline(bool NewValue)
{
	...
	Params::BP_ZombieBoss_C_Outline Parms{};
...
void ABP_ZombieBoss_C::OverrideName(const class FString& Name_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "OverrideName");

	Params::BP_ZombieBoss_C_OverrideName Parms{};
...
// Function BP_ZombieBoss.BP_ZombieBoss_C.PickupBuildFromGround
// (Public, BlueprintCallable, BlueprintEvent)

void ABP_ZombieBoss_C::PickupBuildFromGround()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "PickupBuildFromGround");
...
void ABP_ZombieBoss_C::PlayAttack()
{
	static class UFunction* Func = nullptr;
...
void ABP_ZombieBoss_C::RadiationDamage(class AActor* Object)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_RadiationDamage Parms{};
...
void ABP_ZombieBoss_C::RangedAttack(const struct FVector& Target)
{
	...
	Params::BP_ZombieBoss_C_RangedAttack Parms{};
...
void ABP_ZombieBoss_C::ReceiveAnyDamage(float Damage, const class UDamageType* DamageType, class AController* InstigatedBy, class AActor* DamageCauser)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_ReceiveAnyDamage Parms{};
...
void ABP_ZombieBoss_C::RightArmTrace()
{
	static class UFunction* Func = nullptr;
...
void ABP_ZombieBoss_C::SetBurning(bool Burning_, double Dmg, class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "SetBurning");

	Params::BP_ZombieBoss_C_SetBurning Parms{};
...
void ABP_ZombieBoss_C::SetInteractDistance(class AActor* Target)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_SetInteractDistance Parms{};
...
void ABP_ZombieBoss_C::SetInteractOption(const struct FGameplayTag& Option)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_SetInteractOption Parms{};
...
void ABP_ZombieBoss_C::SetPickupCount(int32 NewCount, bool* Result)
{
	...
	Params::BP_ZombieBoss_C_SetPickupCount Parms{};
...
// Function BP_ZombieBoss.BP_ZombieBoss_C.StopBurning
// (BlueprintCallable, BlueprintEvent)

void ABP_ZombieBoss_C::StopBurning()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ZombieBoss_C", "StopBurning");
...
void ABP_ZombieBoss_C::AI_Is_Dead_(bool* Dead_0) const
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_ZombieBoss_C_AI_Is_Dead_ Parms{};
