...
// WidgetBlueprintGeneratedClass OldChestContainer_Widget.OldChestContainer_Widget_C
// 0x0010 (0x02D0 - 0x02C0)
class UOldChestContainer_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_OldChestContainer_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"OldChestContainer_Widget_C">();
	}
	static class UOldChestContainer_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UOldChestContainer_Widget_C>();
	}
};
static_assert(alignof(UOldChestContainer_Widget_C) == 0x000008, "Wrong alignment on UOldChestContainer_Widget_C");
static_assert(sizeof(UOldChestContainer_Widget_C) == 0x0002D0, "Wrong size on UOldChestContainer_Widget_C");
static_assert(offsetof(UOldChestContainer_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UOldChestContainer_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UOldChestContainer_Widget_C, MainContainer) == 0x0002C8, "Member 'UOldChestContainer_Widget_C::MainContainer' has a wrong offset!");
