...
// BlueprintGeneratedClass BP_BlackOpsHelmetPickup.BP_BlackOpsHelmetPickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_BlackOpsHelmetPickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_BlackOpsHelmetPickup_C;          // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_BlackOpsHelmetPickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_BlackOpsHelmetPickup_C">();
	}
	static class ABP_BlackOpsHelmetPickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_BlackOpsHelmetPickup_C>();
	}
};
static_assert(alignof(ABP_BlackOpsHelmetPickup_C) == 0x000008, "Wrong alignment on ABP_BlackOpsHelmetPickup_C");
static_assert(sizeof(ABP_BlackOpsHelmetPickup_C) == 0x000318, "Wrong size on ABP_BlackOpsHelmetPickup_C");
static_assert(offsetof(ABP_BlackOpsHelmetPickup_C, UberGraphFrame_BP_BlackOpsHelmetPickup_C) == 0x000310, "Member 'ABP_BlackOpsHelmetPickup_C::UberGraphFrame_BP_BlackOpsHelmetPickup_C' has a wrong offset!");
