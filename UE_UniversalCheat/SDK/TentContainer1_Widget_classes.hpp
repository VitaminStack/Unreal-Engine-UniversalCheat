...
// WidgetBlueprintGeneratedClass TentContainer1_Widget.TentContainer1_Widget_C
// 0x0010 (0x02D0 - 0x02C0)
class UTentContainer1_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_TentContainer1_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"TentContainer1_Widget_C">();
	}
	static class UTentContainer1_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTentContainer1_Widget_C>();
	}
};
static_assert(alignof(UTentContainer1_Widget_C) == 0x000008, "Wrong alignment on UTentContainer1_Widget_C");
static_assert(sizeof(UTentContainer1_Widget_C) == 0x0002D0, "Wrong size on UTentContainer1_Widget_C");
static_assert(offsetof(UTentContainer1_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UTentContainer1_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTentContainer1_Widget_C, MainContainer) == 0x0002C8, "Member 'UTentContainer1_Widget_C::MainContainer' has a wrong offset!");
