...
static_assert(sizeof(UFFXFSR3Settings) == 0x0000D0, "Wrong size on UFFXFSR3Settings");
...
static_assert(offsetof(UFFXFSR3Settings, VelocityFactor) == 0x000068, "Member 'UFFXFSR3Settings::VelocityFactor' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, bReactiveMask) == 0x00006C, "Member 'UFFXFSR3Settings::bReactiveMask' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ReflectionScale) == 0x000070, "Member 'UFFXFSR3Settings::ReflectionScale' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ReflectionLuminanceBias) == 0x000074, "Member 'UFFXFSR3Settings::ReflectionLuminanceBias' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, RoughnessScale) == 0x000078, "Member 'UFFXFSR3Settings::RoughnessScale' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, RoughnessBias) == 0x00007C, "Member 'UFFXFSR3Settings::RoughnessBias' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, RoughnessMaxDistance) == 0x000080, "Member 'UFFXFSR3Settings::RoughnessMaxDistance' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, bReactiveMaskRoughnessForceMaxDistance) == 0x000084, "Member 'UFFXFSR3Settings::bReactiveMaskRoughnessForceMaxDistance' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, TranslucencyBias) == 0x000088, "Member 'UFFXFSR3Settings::TranslucencyBias' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, TranslucencyLuminanceBias) == 0x00008C, "Member 'UFFXFSR3Settings::TranslucencyLuminanceBias' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, TranslucencyMaxDistance) == 0x000090, "Member 'UFFXFSR3Settings::TranslucencyMaxDistance' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ReactiveShadingModelID) == 0x000094, "Member 'UFFXFSR3Settings::ReactiveShadingModelID' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ForceReactiveMaterialValue) == 0x000098, "Member 'UFFXFSR3Settings::ForceReactiveMaterialValue' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ReactiveHistoryTranslucencyBias) == 0x00009C, "Member 'UFFXFSR3Settings::ReactiveHistoryTranslucencyBias' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ReactiveHistoryTranslucencyLumaBias) == 0x0000A0, "Member 'UFFXFSR3Settings::ReactiveHistoryTranslucencyLumaBias' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, PreDOFTranslucencyScale) == 0x0000A4, "Member 'UFFXFSR3Settings::PreDOFTranslucencyScale' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, bPreDOFTranslucencyMax) == 0x0000A8, "Member 'UFFXFSR3Settings::bPreDOFTranslucencyMax' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ReactiveMaskDeferredDecalScale) == 0x0000AC, "Member 'UFFXFSR3Settings::ReactiveMaskDeferredDecalScale' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ReactiveHistoryDeferredDecalScale) == 0x0000B0, "Member 'UFFXFSR3Settings::ReactiveHistoryDeferredDecalScale' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ReactiveMaskTAAResponsiveValue) == 0x0000B4, "Member 'UFFXFSR3Settings::ReactiveMaskTAAResponsiveValue' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ReactiveHistoryTAAResponsiveValue) == 0x0000B8, "Member 'UFFXFSR3Settings::ReactiveHistoryTAAResponsiveValue' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ReactiveMaskCustomStencilScale) == 0x0000BC, "Member 'UFFXFSR3Settings::ReactiveMaskCustomStencilScale' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, ReactiveHistoryCustomStencilScale) == 0x0000C0, "Member 'UFFXFSR3Settings::ReactiveHistoryCustomStencilScale' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, CustomStencilMask) == 0x0000C4, "Member 'UFFXFSR3Settings::CustomStencilMask' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, CustomStencilShift) == 0x0000C8, "Member 'UFFXFSR3Settings::CustomStencilShift' has a wrong offset!");
