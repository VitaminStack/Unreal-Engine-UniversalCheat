...
#include "Buildable_Radio_classes.hpp"
#include "Buildable_Radio_parameters.hpp"
...
void ABuildable_Radio_C::OnServerExecuteInteract(const struct FGameplayTag& Option, class AActor* ByActor, const struct FS_JigPayload& Payload)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Buildable_Radio_C", "OnServerExecuteInteract");

	Params::Buildable_Radio_C_OnServerExecuteInteract Parms{};
