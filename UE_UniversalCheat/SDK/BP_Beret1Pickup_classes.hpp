...
// BlueprintGeneratedClass BP_Beret1Pickup.BP_Beret1Pickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_Beret1Pickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_Beret1Pickup_C;                  // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	...
	void ExecuteUbergraph_BP_Beret1Pickup(int32 EntryPoint);
	void Jig_GetEquipMontage(bool CanChamber_, class UAnimMontage** EquipMontage);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"BP_Beret1Pickup_C">();
	}
	static class ABP_Beret1Pickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Beret1Pickup_C>();
	}
};
static_assert(alignof(ABP_Beret1Pickup_C) == 0x000008, "Wrong alignment on ABP_Beret1Pickup_C");
static_assert(sizeof(ABP_Beret1Pickup_C) == 0x000318, "Wrong size on ABP_Beret1Pickup_C");
static_assert(offsetof(ABP_Beret1Pickup_C, UberGraphFrame_BP_Beret1Pickup_C) == 0x000310, "Member 'ABP_Beret1Pickup_C::UberGraphFrame_BP_Beret1Pickup_C' has a wrong offset!");
