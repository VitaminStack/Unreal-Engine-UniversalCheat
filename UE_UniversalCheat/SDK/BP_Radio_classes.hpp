...
class ABP_Radio_C final : public ABP_MasterObject_C
{
public:
	...
	class USoundBase*                             Sound;                                             // 0x02C0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_Radio_C) == 0x0002C8, "Wrong size on ABP_Radio_C");
static_assert(offsetof(ABP_Radio_C, UberGraphFrame) == 0x0002A0, "Member 'ABP_Radio_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_Radio_C, AIOSubject) == 0x0002A8, "Member 'ABP_Radio_C::AIOSubject' has a wrong offset!");
static_assert(offsetof(ABP_Radio_C, Audio) == 0x0002B0, "Member 'ABP_Radio_C::Audio' has a wrong offset!");
static_assert(offsetof(ABP_Radio_C, StaticMesh) == 0x0002B8, "Member 'ABP_Radio_C::StaticMesh' has a wrong offset!");
static_assert(offsetof(ABP_Radio_C, Sound) == 0x0002C0, "Member 'ABP_Radio_C::Sound' has a wrong offset!");
