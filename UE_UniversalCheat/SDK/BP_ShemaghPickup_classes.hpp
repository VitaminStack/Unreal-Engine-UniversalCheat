...
// BlueprintGeneratedClass BP_ShemaghPickup.BP_ShemaghPickup_C
// 0x0008 (0x0318 - 0x0310)
class ABP_ShemaghPickup_C final : public ABP_StaticMeshPickup_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_ShemaghPickup_C;                 // 0x0310(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_BP_ShemaghPickup(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_ShemaghPickup_C">();
	}
	static class ABP_ShemaghPickup_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_ShemaghPickup_C>();
	}
};
static_assert(alignof(ABP_ShemaghPickup_C) == 0x000008, "Wrong alignment on ABP_ShemaghPickup_C");
static_assert(sizeof(ABP_ShemaghPickup_C) == 0x000318, "Wrong size on ABP_ShemaghPickup_C");
static_assert(offsetof(ABP_ShemaghPickup_C, UberGraphFrame_BP_ShemaghPickup_C) == 0x000310, "Member 'ABP_ShemaghPickup_C::UberGraphFrame_BP_ShemaghPickup_C' has a wrong offset!");
