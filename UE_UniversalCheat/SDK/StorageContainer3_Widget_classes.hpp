...
// WidgetBlueprintGeneratedClass StorageContainer3_Widget.StorageContainer3_Widget_C
// 0x0010 (0x02D0 - 0x02C0)
class UStorageContainer3_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_StorageContainer3_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"StorageContainer3_Widget_C">();
	}
	static class UStorageContainer3_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UStorageContainer3_Widget_C>();
	}
};
static_assert(alignof(UStorageContainer3_Widget_C) == 0x000008, "Wrong alignment on UStorageContainer3_Widget_C");
static_assert(sizeof(UStorageContainer3_Widget_C) == 0x0002D0, "Wrong size on UStorageContainer3_Widget_C");
static_assert(offsetof(UStorageContainer3_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UStorageContainer3_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UStorageContainer3_Widget_C, MainContainer) == 0x0002C8, "Member 'UStorageContainer3_Widget_C::MainContainer' has a wrong offset!");
