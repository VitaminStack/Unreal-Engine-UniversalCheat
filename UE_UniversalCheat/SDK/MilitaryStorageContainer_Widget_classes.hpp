...
// WidgetBlueprintGeneratedClass MilitaryStorageContainer_Widget.MilitaryStorageContainer_Widget_C
// 0x0010 (0x02D0 - 0x02C0)
class UMilitaryStorageContainer_Widget_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_MilitaryStorageContainer_Widget(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"MilitaryStorageContainer_Widget_C">();
	}
	static class UMilitaryStorageContainer_Widget_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMilitaryStorageContainer_Widget_C>();
	}
};
static_assert(alignof(UMilitaryStorageContainer_Widget_C) == 0x000008, "Wrong alignment on UMilitaryStorageContainer_Widget_C");
static_assert(sizeof(UMilitaryStorageContainer_Widget_C) == 0x0002D0, "Wrong size on UMilitaryStorageContainer_Widget_C");
static_assert(offsetof(UMilitaryStorageContainer_Widget_C, UberGraphFrame) == 0x0002C0, "Member 'UMilitaryStorageContainer_Widget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMilitaryStorageContainer_Widget_C, MainContainer) == 0x0002C8, "Member 'UMilitaryStorageContainer_Widget_C::MainContainer' has a wrong offset!");
